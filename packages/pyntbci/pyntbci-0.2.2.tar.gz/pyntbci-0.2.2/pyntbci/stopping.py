...
class BetaStopping(BaseEstimator, ClassifierMixin):
    """Beta dynamic stopping [2]_. Fits a beta distribution to non-max (correlation+1)/2, and tests the probability of
    the maximum correlation to belong to that same distribution.
...
class MarginStopping(BaseEstimator, ClassifierMixin):
    """
    Margin dynamic stopping [3]_. Learns threshold margins (difference between best and second best score) to stop at
