...
from wt_mqtt.wt_device_mqtt import WTDeviceMqttClient, DEVICE_TS_KV_VALIDATOR, KV_VALIDATOR
...
class WTGatewayMqttClient(WTDeviceMqttClient):
    ...
    def connect(self, callback=None, min_reconnect_delay=1, timeout=120, tls=False, ca_certs=None, cert_file=None, key_file=None, keepalive=120):
        super(WTGatewayMqttClient, self).connect(callback, min_reconnect_delay, timeout, tls, ca_certs, cert_file, key_file, keepalive)
