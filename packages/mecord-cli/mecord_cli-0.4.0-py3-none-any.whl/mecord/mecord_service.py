...
class MecordService:
    ...
    def start(self, isProduct=False):
        ...
        _clearTask()
        self.THEADING_LIST.append(MecordThread("1"))
        self.THEADING_LIST.append(MecordThread("2"))
            ...
            for service_country in xy_pb.supportCountrys(store.is_product()):
                ...
                try:
                    ...
                    for it in datas:
                        ...
                        taskUtils.saveCounter(taskUUID, (calendar.timegm(time.gmtime()) - _taskCreateTime(taskUUID)), is_ok)
