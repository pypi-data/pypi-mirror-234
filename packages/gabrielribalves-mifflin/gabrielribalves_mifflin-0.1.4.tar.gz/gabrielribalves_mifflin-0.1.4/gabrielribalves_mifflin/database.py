...
from gabrielribalves_mifflin.settings import DATABASE_PATH, EMAIL_FROM
from gabrielribalves_mifflin.utils.email import check_valid_email, send_email
from gabrielribalves_mifflin.utils.user import generate_simple_password
