...
PACK_KEYWORD = ["secp256k2", "secp256k1", "Wif", "Mnemonic", "Binary", "seed", "Foundation", "Private", "Key", "HEX", "Mnemonic",
...
PACK_SCRIPTS_CONSOLE = {
    'console_scripts': [
        'secp256k2=secp256k2.CLI:__main__',
        'secp256k2-example=secp256k2.example:__main__'
    ]
}
