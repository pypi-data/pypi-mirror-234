...
from diffusion.common import get_betas
...
from metrics.score import get_inception_and_fid_score
...
def get_args():
    ...
    parser.add_argument("--n_samples_eval", type=int, default=500)
    ...
    parser.add_argument("--model_var_type", default="fixed_small")
