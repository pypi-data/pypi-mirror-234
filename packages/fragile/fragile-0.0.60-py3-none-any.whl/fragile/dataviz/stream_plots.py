...
class Image(StreamingPlot):
    ...
    def __init__(self, data=None, plot=holoviews.Image, **kwargs):
        ...
        super(Image, self).__init__(plot=plot, data=data, **kwargs)
...
class PlotCallback(Callback):
    def __init__(self, report_interval: int = 1, **kwargs):
        self.report_interval_widget = panel.widgets.IntInput(
    ...
    def after_evolve(self):
        # TODO: Is this a bug or a feature? Figure out why the before_walkers call is needed.
