...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.service_details = customtkinter.CTkTextbox(self.service_editor, height=320)
    ...
    def make_request(self):
        ...
        self.service_status.delete(0)
        self.service_status.insert(text=str(status), index=0)
        self.service_name.delete(0)
        self.service_name.insert(text=str(response_json["metainfo"]["name"]), index=0)
        self.service_description.delete(0)
        self.service_description.insert(text=str(response_json["metainfo"]["description"]), index=0)
        self.service_details.delete(0)
        self.service_details.insert(text=json.dumps(response_json, indent=4), index=0)
