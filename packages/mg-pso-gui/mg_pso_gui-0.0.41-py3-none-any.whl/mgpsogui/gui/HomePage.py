...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.load_parameters = customtkinter.CTkButton(self.service_editor, text="Connect", command=self.load)
        ...
        self.service_status = customtkinter.CTkLabel(self.service_editor, text="Service Status: Unknown")
        self.service_status.grid(row=1, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_name = customtkinter.CTkLabel(self.service_editor, text="")
        self.service_name.grid(row=2, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_description = customtkinter.CTkLabel(self.service_editor, text="")
        self.service_description.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_editor = customtkinter.CTkScrollableFrame(self.tabview.tab(tab1), label_text="Environment Editor")
        self.service_editor.grid(row=1, column=1, padx=(20, 20), pady=(20, 20), sticky="nsew")
        
        self.create_environment_button = customtkinter.CTkButton(self.service_editor, text="Create")
        self.create_environment_button.grid(row=0, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.destroy_environment_button = customtkinter.CTkButton(self.service_editor, text="Stop")
        self.destroy_environment_button.grid(row=0, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
