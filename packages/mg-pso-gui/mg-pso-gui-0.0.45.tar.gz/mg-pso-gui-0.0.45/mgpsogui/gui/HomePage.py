...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.service_status = customtkinter.CTkLabel(self.service_editor, text="Service Status:\nUnknown", anchor="w")
        self.service_status.grid(row=1, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_name = customtkinter.CTkLabel(self.service_editor, text="Name:\nUnknown", anchor="w")
        self.service_name.grid(row=2, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_description = customtkinter.CTkLabel(self.service_editor, text="Description:\nUnknown", anchor="w")
        self.service_description.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_details = customtkinter.CTkLabel(self.service_editor, text="Details:\nUnknown", anchor="w")
        self.service_details.grid(row=4, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        ...
        self.create_environment_button = customtkinter.CTkButton(self.environment_editor, text="Create")
        self.create_environment_button.grid(row=0, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.destroy_environment_button = customtkinter.CTkButton(self.environment_editor, text="Stop")
        self.destroy_environment_button.grid(row=1, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
