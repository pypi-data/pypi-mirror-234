...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.service_status = customtkinter.CTkTextbox(self.service_editor, height=40)
        ...
        self.service_name = customtkinter.CTkTextbox(self.service_editor, height=40)
        ...
        self.service_description = customtkinter.CTkTextbox(self.service_editor, height=40)
        ...
        self.service_details = customtkinter.CTkTextbox(self.service_editor, height=400)
