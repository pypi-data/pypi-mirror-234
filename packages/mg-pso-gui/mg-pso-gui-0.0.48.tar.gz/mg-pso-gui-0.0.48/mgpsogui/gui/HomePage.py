...
class App(customtkinter.CTk):
    ...
    def make_request(self):
        ...
        self.service_status.insert(text=str(status))
        self.service_name.insert(text=str(response_json["metainfo"]["name"]))
        self.service_description.insert(text=str(response_json["metainfo"]["description"]))
        self.service_details.insert(text=json.dumps(response_json, indent=4))
