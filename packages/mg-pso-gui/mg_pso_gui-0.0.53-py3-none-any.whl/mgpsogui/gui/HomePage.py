...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.start_cluster_button.grid(row=1, column=0, padx=(20, 20), pady=(5, 5), sticky="ew")
        
        self.create_environment_button = customtkinter.CTkButton(self.environment_editor, text="Deploy Environment")
        self.create_environment_button.grid(row=2, column=0, padx=(20, 20), pady=(5, 5), sticky="ew")
        
        self.get_status = customtkinter.CTkButton(self.environment_editor, text="Cluster Status", command=self.cluster_status)
        self.get_status.grid(row=3, column=0, padx=(20, 20), pady=(5, 5), sticky="ew")
        ...
        self.destroy_environment_button.grid(row=4, column=0, padx=(20, 20), pady=(5, 5), sticky="ew")
    ...
    def cluster_status(self):
        ...
        if error:
            ...
            self.custer_details.insert("0.0", error + "\n\n")
        else:
            print(f"Output: {output}")
            self.custer_details.insert("0.0", output + "\n\n")
