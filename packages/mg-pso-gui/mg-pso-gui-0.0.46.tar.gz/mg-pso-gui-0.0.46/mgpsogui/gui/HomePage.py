...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.top_bar_container.grid_columnconfigure(0, weight=1)
        self.top_bar_container.grid_rowconfigure(0, weight=1)
        ...
        cl.grid(row=1, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_status = customtkinter.CTkTextbox(self.service_editor)
        self.service_status.grid(row=2, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        cl = customtkinter.CTkLabel(self.service_editor, text="Service Name:", anchor="w")
        cl.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_name = customtkinter.CTkTextbox(self.service_editor)
        self.service_name.grid(row=4, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        cl = customtkinter.CTkLabel(self.service_editor, text="Service Description:", anchor="w")
        cl.grid(row=5, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_description = customtkinter.CTkTextbox(self.service_editor)
        self.service_description.grid(row=6, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        cl = customtkinter.CTkLabel(self.service_editor, text="Service Details:", anchor="w")
        cl.grid(row=7, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.service_details = customtkinter.CTkTextbox(self.service_editor)
        self.service_details.grid(row=8, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        ...
        def start_cluster(self):
            subprocess.Popen(["minikube", "start"])
            
        def stop_cluster(self):
            subprocess.Popen(["minikube", "stop"])
        
        self.start_cluster_button = customtkinter.CTkButton(self.environment_editor, text="Start Cluster", command=start_cluster)
        self.start_cluster_button.grid(row=0, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.create_environment_button = customtkinter.CTkButton(self.environment_editor, text="Deploy Environment")
        self.create_environment_button.grid(row=1, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
        
        self.destroy_environment_button = customtkinter.CTkButton(self.environment_editor, text="Stop Cluster", command=stop_cluster)
        self.destroy_environment_button.grid(row=2, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
    ...
    def make_request(self):
        ...
        self.service_status.configure(text="Service Status:\n" + str(status))
        self.service_name.configure(text="Name:\n" + str(response_json["metainfo"]["name"]))
        self.service_description.configure(text="Description:\n" + str(response_json["metainfo"]["description"]))
        self.service_details.configure(text="Details:\n" + str(response_json))
