...
class PilotDriver():
    ...
    def try_build_drivers(self):
        ...
        try:
            ...
            self.sbc.cmd("git clone --depth=1 https://github.com/pilotnexus/pilotdriver.git ~/pilotdriver && cd ~/pilotdriver && make prepare && make && make package && sudo make install", True)
