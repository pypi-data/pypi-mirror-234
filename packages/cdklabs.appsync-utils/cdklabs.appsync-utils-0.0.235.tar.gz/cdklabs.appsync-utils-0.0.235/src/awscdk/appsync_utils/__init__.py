...
class SourceApiAssociationMergeOperationProvider(
    ...
    def schema_merge_lambda(self) -> _aws_cdk_aws_lambda_ceddda9d.Function:
        '''The lambda function responsible for kicking off the merge operation.'''
        return typing.cast(_aws_cdk_aws_lambda_ceddda9d.Function, jsii.get(self, "schemaMergeLambda"))
    ...
    def source_api_stablization_lambda(self) -> _aws_cdk_aws_lambda_ceddda9d.Function:
        '''The lambda function response for ensuring that the merge operation finished.'''
        return typing.cast(_aws_cdk_aws_lambda_ceddda9d.Function, jsii.get(self, "sourceApiStablizationLambda"))
