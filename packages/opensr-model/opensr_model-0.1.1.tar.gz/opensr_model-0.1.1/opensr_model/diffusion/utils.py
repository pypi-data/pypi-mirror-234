...
from typing import Optional, Tuple, Union, Any, Callable, List, Dict, Iterable
...
def make_convolutional_sample(
    ...
    with model.ema_scope("Plotting"):
        ...
        sample, intermediates = sample, intermediates = convsample_ddim(
            model=model, cond=c, 
            steps=custom_steps, shape=z.shape,
            eta=eta, quantize_x0=quantize_x0,
            noise_dropout=noise_dropout,
            mask=None, x0=None, temperature=temperature,
...
def convsample_ddim(
    ...
    samples, intermediates = ddim.sample(steps, batch_size=bs, shape=shape, conditioning=cond, callback=callback,
                                         ...
                                         score_corrector=score_corrector, noise_dropout=noise_dropout,
...
class LitEma(nn.Module):
    def __init__(self, model: nn.Module, decay: float = 0.9999, use_num_upates: bool = True) -> None:
        """
