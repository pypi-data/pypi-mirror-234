 ...
 class analysation:
    ...
    def mito_stats(self):
        ...
        sc.pl.violin(mito_data, ['n_genes_by_counts', 'total_counts', 'pct_counts_mt', 'pct_counts_ribo', 'pct_counts_hb'],
                     jitter=0.4, rotation=45, "Violin Plots of Quality Indicators")
        sc.pl.violin(mito_data, ['pct_counts_mt'],
                     jitter=0.4, rotation=45, title = "Violin Plot of Mito Data")
        sc.pl.scatter(mito_data, x='total_counts', y='pct_counts_mt', "Scatter Plot of pct_counts_mt")
        sc.pl.scatter(mito_data, x='total_counts', y='n_genes_by_counts', "Scatter Plot of n_genes_by_counts")
