...
from dotcoder import models, prompts, utils
from dotcoder.commands import Commands
from dotcoder.history import ChatSummary
from dotcoder.repo import GitRepo
from dotcoder.repomap import RepoMap
from dotcoder.sendchat import send_with_retries
...
class Coder:
    abs_fnames = None
    repo = None
    last_dotcoder_commit_hash = None
    ...
    def auto_commit(self, edited):
        ...
        res = self.repo.commit(fnames=edited, context=context, prefix="dotcoder: ")
        if res:
            commit_hash, commit_message = res
            self.last_dotcoder_commit_hash = commit_hash
