...
from dotcoder import __version__, models
from dotcoder.coders import Coder
from dotcoder.io import InputOutput
from dotcoder.repo import GitRepo
from dotcoder.versioncheck import check_version
...
def main(argv=None, input=None, output=None, force_git_root=None):
    ...
    conf_fname = Path(".dotcoder.conf.yml")
    ...
    parser = configargparse.ArgumentParser(
        description="dotcoder is GPT powered coding in your terminal",
        add_config_file_help=True,
        default_config_files=default_config_files,
        config_file_parser_class=configargparse.YAMLConfigFileParser,
        auto_env_var_prefix="DOTCODER_",
    )
    ...
    default_input_history_file = (
        os.path.join(git_root, ".dotcoder.input.history") if git_root else ".dotcoder.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".dotcoder.chat.history.md") if git_root else ".dotcoder.chat.history.md"
    )
    ...
    git_group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .dotcoder* to .gitignore (default: True)",
    )
    git_group.add_argument(
        "--auto-commits",
        action=argparse.BooleanOptionalAction,
    ...
    other_group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .dotcoder.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    ...
    io.tool_output(f"Dotcoder v{__version__}")
