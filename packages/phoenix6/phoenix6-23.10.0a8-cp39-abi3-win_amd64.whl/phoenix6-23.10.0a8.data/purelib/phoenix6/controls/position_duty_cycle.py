...
class PositionDutyCycle:
    def __init__(self, position: float, velocity: float, enable_foc: bool, feed_forward: float, slot: int, override_brake_dur_neutral: bool):
        """
        ...
        """
        self.control_info = {}
        self.control_info["name"] = "PositionDutyCycle"
