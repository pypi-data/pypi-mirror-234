...
class bars:
	...
	def preset(self,path,spotprice,expiryday,month,year):
		...
		try:
			...
			self.u.logevent('cetokn ',self.cetoken)
			self.u.logevent('petokn ',self.petoken)
			self.u.logevent('cescid ',self.cesecid)
			self.u.logevent('pescid ',self.pesecid)
		...
		# call/put structure
		self.cef=self.f
		self.u.logevent('cef ',self.cef)
		self.pef=self.f
		self.u.logevent('pef ',self.cef)
		pass
