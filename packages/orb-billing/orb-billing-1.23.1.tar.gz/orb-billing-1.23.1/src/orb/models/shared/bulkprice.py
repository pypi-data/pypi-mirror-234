...
class BulkPriceModelType(str, Enum):
    BULK = 'bulk'
...
class BulkPrice:
    ...
    model_type: BulkPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
