...
class MatrixPriceModelType(str, Enum):
    MATRIX = 'matrix'
...
class MatrixPrice:
    ...
    model_type: MatrixPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
