...
class PackagePriceModelType(str, Enum):
    PACKAGE = 'package'
...
class PackagePrice:
    ...
    model_type: PackagePriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
