...
class BulkBpsPriceModelType(str, Enum):
    BULK_BPS = 'bulk_bps'
...
class BulkBpsPrice:
    ...
    model_type: BulkBpsPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
