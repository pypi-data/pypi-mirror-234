...
class TieredPriceModelType(str, Enum):
    TIERED = 'tiered'
...
class TieredPrice:
    ...
    model_type: TieredPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
