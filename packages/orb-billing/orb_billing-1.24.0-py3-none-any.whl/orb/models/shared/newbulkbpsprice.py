...
class NewBulkBpsPriceModelType(str, Enum):
    BULK_BPS = 'bulk_bps'
...
class NewBulkBpsPrice:
    ...
    model_type: NewBulkBpsPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
