...
class NewBpsPriceModelType(str, Enum):
    BPS = 'bps'
...
class NewBpsPrice:
    ...
    model_type: NewBpsPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
