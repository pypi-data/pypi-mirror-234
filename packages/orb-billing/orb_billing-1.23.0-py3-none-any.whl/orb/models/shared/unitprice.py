...
class UnitPriceModelType(str, Enum):
    UNIT = 'unit'
...
class UnitPrice:
    ...
    model_type: UnitPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
