...
class NewMatrixPriceModelType(str, Enum):
    MATRIX = 'matrix'
...
class NewMatrixPrice:
    ...
    matrix_config: dict[str, Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('matrix_config') }})
    model_type: NewMatrixPriceModelType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_type') }})
