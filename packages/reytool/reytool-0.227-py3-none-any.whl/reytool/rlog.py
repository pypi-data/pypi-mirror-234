...
class RLog(object):
    ...
    def add_file(
        ...
        level : Handler level.
        format_ : Print record format.
        size : File split condition, max megabyte. Cannot be less than 1, prevent infinite split file.
        ...
        if (
            ...
            raise AssertionError("parameter 'size' and 'time' cannot be used together")

        ## By size split.
        elif size is not None:
            if size < 1:
                rexc(ValueError, size)
    ...
    def log(
        ...
        *messages: Optional[Any]
        ...
        if (
            ...
            and stack_param["line"] == "print(text)"
        ):
