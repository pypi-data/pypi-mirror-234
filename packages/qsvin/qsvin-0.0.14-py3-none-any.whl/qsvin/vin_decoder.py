...
class VinDecoder:
    ...
    def _parse_vin(self, v):
        ...
        insert_data={**vin_info, **external_api_res, "other": {**vin_info.get("other", {}), **external_api_res.get("other", {})}} if all([external_api_res.get('vds', None),external_api_res.get('wmi', None),external_api_res.get('vis', None)]) else vin_info
    ...
    def export_excel(self, vin, query=None, fname="output.xlsx"):
        """
        ...
        """
        response = self.lookup_vin(vin=vin, query=query)
