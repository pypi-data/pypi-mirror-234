    ...
    def train(self, df, client_id=None,
        ...
        if res['batches_saved']==res['total_batches']:
            self.__train(
                ...
                categorical_fields=[ fref['forward'][var] for var in categorical_vars ] if encoding else categorical_vars, 
                saturation_fields=[ fref['forward'][var] for var in saturation_vars ] if encoding else saturation_vars,
                lagging_fields=[ fref['forward'][var] for var in lagging_vars ] if encoding else lagging_vars,
                algorithm=algorithm,
