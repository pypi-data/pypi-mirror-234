...
class DungeonsandtrollsEvent(BaseModel):
    ...
    is_ranged: Optional[StrictBool] = Field(None, alias="isRanged")
    __properties = ["message", "type", "coordinates", "damage", "playerId", "skillName", "radius", "target", "skill", "isRanged"]
    ...
    def to_dict(self):
        ...
        # set to None if is_ranged (nullable) is None
        # and __fields_set__ contains the field
        if self.is_ranged is None and "is_ranged" in self.__fields_set__:
            _dict['isRanged'] = None
