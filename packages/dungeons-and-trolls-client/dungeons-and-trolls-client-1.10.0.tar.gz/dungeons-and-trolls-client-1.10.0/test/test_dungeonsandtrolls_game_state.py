                ...
                map = dungeons_and_trolls_client.models.dungeonsandtrolls_map.dungeonsandtrollsMap(
                    levels = [
                        dungeons_and_trolls_client.models.dungeonsandtrolls_level.dungeonsandtrollsLevel(
                            ...
                            fog_of_war = [
                                dungeons_and_trolls_client.models.dungeonsandtrolls_fog_of_war_map.dungeonsandtrollsFogOfWarMap()
                                ], 
                            player_map = [
                                dungeons_and_trolls_client.models.dungeonsandtrolls_player_specific_map.dungeonsandtrollsPlayerSpecificMap(
                                    distance = 56, 
                                    line_of_sight = True, )
                                ], )
                        ], ),
