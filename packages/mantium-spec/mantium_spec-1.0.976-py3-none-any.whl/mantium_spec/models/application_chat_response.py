...
"""
    ...
    The version of the OpenAPI document: 1.0.976
...
class ApplicationChatResponse(object):
    ...
    def __init__(self, query=None, chat_session_id=None, retriever_top_k=10, reader_top_k=5, answers=None, documents=None, supporting_content=None, citations=None, local_vars_configuration=None):  # noqa: E501
