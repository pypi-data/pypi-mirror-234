...
from xmind2testcase_wzc.zentao import xmind_to_zentao_csv_file, xmind_to_zentao_xlsx_file_by_pandas
from xmind2testcase_wzc.testlink import xmind_to_testlink_xml_file
from xmind2testcase_wzc.utils import get_xmind_testsuites, get_xmind_testcase_list
...
def init():
    ...
    if not exists(DATABASE):
        init_db()
    app.logger.info('Congratulations! the xmind2testcase_wzc webtool database has initialized successfully!')
