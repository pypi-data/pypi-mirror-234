...
class TestSuite(object):
    ...
    def __init__(self, name='', req='',details='', testcase_list=None, sub_suites=None, statistics=None, status=''):
        """
        TestSuite
...
class TestCase(object):
    ...
    def __init__(self, name='', req='', version=1, summary='', preconditions='', execution_type=1, importance=2, estimated_exec_duration=3, status=7, result=0, steps=None):
        """
        TestCase
