...
This script generates the element classes in the dotreact.el.elements module.
Run as follows:

    python -m dotreact.el.precompile
...
from dotreact.utils import path_ops
...
INIT_PY = [
    ...
    "",
    "from dotreact.el.element import Element",
    "from dotreact.vars import Var as Var_",
    "",
]
