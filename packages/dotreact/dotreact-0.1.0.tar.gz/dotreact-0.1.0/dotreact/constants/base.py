...
class Dirs(SimpleNamespace):
    """Various directories/paths used by Dotreact."""
...
class Dotreact(SimpleNamespace):
    """Base constants concerning Dotreact."""

    # App names and versions.
    # The name of the Dotreact package.
    MODULE_NAME = "dotreact"
    # The current version of Dotreact.
    VERSION = metadata.version(MODULE_NAME)

    # The dotreact json file.
    JSON = os.path.join(Dirs.WEB, "dotreact.json")

    # Files and directories used to init a new project.
    # The directory to store dotreact dependencies.
    DIR = (
        # on windows, we use C:/Users/<username>/AppData/Local/dotreact.
        # on macOS, we use ~/Library/Application Support/dotreact.
        # on linux, we use ~/.local/share/dotreact.
        PlatformDirs(MODULE_NAME, False).user_data_dir
    )
    # The root directory of the dotreact library.
...
class Templates(SimpleNamespace):
    ...
    class Dirs(SimpleNamespace):
        """Folders used by the template system of Dotreact."""

        # The template directory used during dotreact init.
        BASE = os.path.join(Dotreact.ROOT_DIR, Dotreact.MODULE_NAME, ".templates")
...
SKIP_COMPILE_ENV_VAR = "__DOTREACT_SKIP_COMPILE"
