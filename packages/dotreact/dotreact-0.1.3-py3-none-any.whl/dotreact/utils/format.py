...
from dotreact.utils import exceptions, serializers, types
from dotreact.utils.serializers import serialize
from dotreact.vars import Var

if TYPE_CHECKING:
    from dotreact.components.component import ComponentStyle
    from dotreact.event import EventChain, EventHandler, EventSpec
...
def format_prop(
    ...
    from dotreact.event import EVENT_ARG, EventChain
...
def format_event_chain(
    ...
    if isinstance(event_chain, Var):
        from dotreact.event import EventChain
