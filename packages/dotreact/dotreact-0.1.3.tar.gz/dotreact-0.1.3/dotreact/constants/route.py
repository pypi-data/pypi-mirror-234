...
class DefaultPage(SimpleNamespace):
    ...
    # The default title to show for Dotreact apps.
    TITLE = "Dotreact App"
    # The default description to show for Dotreact apps.
    DESCRIPTION = "A Dotreact app."
    # The default image to show for Dotreact apps.
    IMAGE = "favicon.ico"
    # The default meta list to show for Dotreact apps.
    META_LIST = []
