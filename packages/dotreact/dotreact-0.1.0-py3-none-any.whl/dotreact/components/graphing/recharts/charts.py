...
from dotreact.components.graphing.recharts.general import ResponsiveContainer
...
class ChartBase(RechartsCharts):
    ...
    # If any two categorical charts(dr.line_chart, dr.area_chart, dr.bar_chart, dr.composed_chart) have the same sync_id, these two charts can sync the position GraphingTooltip, and the start_index, end_index of Brush.
    sync_id: Var[str]
