...
from stelios.analytics.oauth_manager import OauthManager

from stelios.analytics.utils import guess_timezone, clean
from stelios.analytics.consumer import Consumer, MAX_MSG_SIZE
from stelios.analytics.request import post, DatetimeSerializer
from stelios.analytics.version import VERSION
...
class Client(object):
    ...
    """Create a new Stelios client."""
    log = logging.getLogger('stelios')
