...
from stelios.analytics import utils
from stelios.analytics.request import APIError
from stelios.analytics.consumer import FatalError
...
class OauthManager(object):
    def __init__(self,
        ...
        self.log = logging.getLogger('stelios')
        self.thread = None
