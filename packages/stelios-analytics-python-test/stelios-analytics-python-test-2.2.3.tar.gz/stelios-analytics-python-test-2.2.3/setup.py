...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'stelios','analytics'))
...
setup(
    ...
    version=VERSION,
    url='https://gitlab.com/fynd/regrowth/boltic/stelios-py',
    author='Stelios',
    author_email='sudhanshusrivastav@gofynd.com',
    maintainer='Stelios',
    maintainer_email='sidharths@gofynd.com',
    test_suite='stelios.analytics.test.all',
    packages=['stelios.analytics', 'stelios.analytics.test'],
