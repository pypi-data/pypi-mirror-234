...
from BSTestNAbila.banks_utils import *
...
from   BSTestNAbila.Incom_expense import income_expense
    ...
    def __process_pdf_and_detect_labels(self, pdf_content, confidence_threshold=0.85):
        try:
            ...
            if images:
                ...
                model_path = pkg_resources.resource_filename('BSTestNAbila', 'models/best.pt')
