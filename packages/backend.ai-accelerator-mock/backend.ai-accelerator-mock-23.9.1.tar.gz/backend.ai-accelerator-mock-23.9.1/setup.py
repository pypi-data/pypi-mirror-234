...
setup(**{
    ...
    'install_requires': (
        'aiodocker~=0.21.0',
        """backend.ai-agent==23.09.1
""",
        """backend.ai-cli==23.09.1
""",
        """backend.ai-common==23.09.1
""",
        """backend.ai-kernel-binary==23.09.1
""",
        """backend.ai-kernel-helper==23.09.1
""",
        """backend.ai-kernel==23.09.1
""",
        """backend.ai-plugin==23.09.1
""",
        'trafaret~=2.1',
    ),
    'license': 'LGPLv3',
