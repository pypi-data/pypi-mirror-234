...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'scn', 'bpy', 'qu', 'mn', 'nv', 'ban', 'xmf', 'si', 'ig', 'tum', 'ps',
        'frr', 'mzn', 'os', 'or', 'bat-smg', 'sah', 'cdo', 'gd', 'bug', 'yi',
        'sd', 'ilo', 'am', 'bcl', 'nap', 'li', 'gor', 'fo', 'hsb', 'map-bms',
        'mai', 'shn', 'eml', 'ace', 'zh-classical', 'as', 'sa', 'wa', 'ie',
        'hyw', 'mhr', 'lij', 'sn', 'zu', 'hif', 'mrj', 'bjn', 'km', 'mni',
        'hak', 'sat', 'roa-tara', 'pam', 'rue', 'nso', 'bh', 'dag', 'so', 'mi',
        'myv', 'se', 'vls', 'nds-nl', 'co', 'sc', 'ary', 'kw', 'bo', 'vep',
        'glk', 'tk', 'kab', 'gan', 'rw', 'fiu-vro', 'gv', 'ab', 'zea', 'ug',
        'nah', 'skr', 'frp', 'mt', 'tly', 'udm', 'pcd', 'kv', 'gn', 'csb',
        'smn', 'ay', 'nrm', 'ks', 'lez', 'olo', 'mwl', 'lfn', 'mdf', 'lo',
        'stq', 'ang', 'fur', 'rm', 'kaa', 'lad', 'ext', 'gom', 'tw', 'tyv',
        'pap', 'koi', 'av', 'dsb', 'ln', 'dty', 'cbk-zam', 'dv', 'ksh', 'za',
        'gag', 'lg', 'bxr', 'pfl', 'szy', 'blk', 'pag', 'tay', 'pi', 'haw',
        'awa', 'inh', 'krc', 'xal', 'pdc', 'to', 'atj', 'tcy', 'arc', 'mnw',
        'shi', 'jam', 'kbp', 'wo', 'anp', 'kbd', 'nia', 'om', 'nov', 'ki',
        'ff', 'xh', 'nqo', 'bi', 'tpi', 'tet', 'roa-rup', 'jbo', 'fj', 'kg',
        'lbe', 'ty', 'guw', 'cu', 'trv', 'ami', 'srn', 'mad', 'sm', 'tn',
        'alt', 'ltg', 'gcr', 'chr', 'ny', 'st', 'pih', 'gpe', 'got', 'rmy',
