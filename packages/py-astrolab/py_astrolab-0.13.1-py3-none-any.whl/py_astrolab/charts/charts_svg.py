    ...
    def __makePlanetGrid(self):
        ...
        for i in range(len(self.planets_settings)):
            ...
            if self.planets_settings[i]['visible'] == 1:
                ...
                if self.planets_retrograde[i]:
                    out += f'<g class="retrograde" transform="translate(28,-6)"><use transform="scale(.5)" xlink:href="#retrogradeWhite" /></g>'
                out += '<g transform="translate(40,-8)"><use transform="scale(0.3)" xlink:href="#' + self.zodiac[self.planets_sign[i]]+'" /></g>'
                out += '<text text-anchor="start" x="50" style="fill:white; font-size: 10px;">%s</text>' % (self.__dec2deg(self.planets_degree[i]))
                out += '<g transform="translate(107,-8)"><use transform="scale(0.4)" xlink:href="#' + self.planets_settings[i]['name']+'White" /></g>'
                out += f'<text text-anchor="start" x="120" style="fill:white; font-size: 10px;">{self.language_settings["planets"][self.planets_settings[i]["label"]]}</text>'
                out += '</g>'
                li = li + 14
        ...
        if self.chart_type == "Transit" or self.chart_type == "Composite":
            ...
            for i in range(len(self.planets_settings)):
                ...
                if self.planets_settings[i]['visible'] == 1:
                    ...
                    out += f'<text text-anchor="end" style="fill:white; font-size: 10px;">{self.language_settings["planets"][self.planets_settings[i]["label"]]}</text>'
                    out += f'<g transform="translate(5,-8)"><use transform="scale(0.4)" xlink:href="#{self.planets_settings[i]["name"]}White" /></g>'
                    out += '<text text-anchor="start" x="19" style="fill:white; font-size: 10px;">%s</text>' % (self.__dec2deg(self.t_planets_degree[i]))
                    out += '<g transform="translate(75,-8)"><use transform="scale(0.3)" xlink:href="#' + self.zodiac[self.t_planets_sign[i]]+'" /></g>'
                    if self.t_planets_retrograde[i]:
                        out += '<g transform="translate(87,-6)"><use transform="scale(.5)" xlink:href="#retrogradeWhite" /></g>'
                    out += '</g>'
                    t_li = t_li + 14
