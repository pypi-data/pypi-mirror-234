    ...
    def __makePlanetGrid(self):
        ...
        for i in range(len(self.planets_settings)):
            ...
            if self.planets_settings[i]['visible'] == 1:
                ...
                if self.planets_retrograde[i]:
                    out += f'<g class="retrograde" transform="translate(37,-6)"><use transform="scale(.5)" xlink:href="#retrograde" /></g>'
                out += '<g transform="translate(50,-8)"><use transform="scale(0.3)" xlink:href="#' + self.zodiac[self.planets_sign[i]]+'" /></g>'
                out += '<text text-anchor="start" x="60" style="fill:white; font-size: 10px;">%s</text>' % (self.__dec2deg(self.planets_degree[i]))
        ...
        if self.chart_type == "Transit" or self.chart_type == "Composite":
            ...
            for i in range(len(self.planets_settings)):
                ...
                if self.planets_settings[i]['visible'] == 1:
                    ...
                    out += '<g transform="translate(60,-8)"><use transform="scale(0.3)" xlink:href="#' + self.zodiac[self.t_planets_sign[i]]+'" /></g>'
