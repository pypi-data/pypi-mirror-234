...
from opr.methods import parse
from opr.runtime import Cfg, Client, Errors, Event, command, output, scan
from opr.storage import Storage
from opr.utility import mods
...
Storage.workdir = os.path.expanduser(f"~/.opr")


opr.runtime.output = print
...
def main():
    ...
    if "d" in Cfg.opts:
        ...
        if 'v' in Cfg.opts:
            ...
            print(f"OPV started at {dtime} {Cfg.opts.upper()} {Cfg.mod.upper()}")
