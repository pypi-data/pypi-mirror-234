...
import os
import warnings
from bsbankspkg.banks import Banks
...
labels = pd.read_csv('Anjali_BS_Extract/bsbankspkg/models/lean/labels')['0']
...
class Incom_expense:   
    ...
    def income_detection(self,pdf_path):
            ...
            model_name = 'places'
            id = pd.Series(pd.to_numeric(os.listdir('Anjali_BS_Extract/bsbankspkg/models/'+model_name), errors='coerce'),).dropna(

            ).sort_values(ascending=False).iloc[0]  

            places_categories = pd.read_csv('Anjali_BS_Extract/bsbankspkg/models/categories.csv',)['0']
            # categories
            places_model = tf.keras.models.load_model('Anjali_BS_Extract/bsbankspkg/models/'+model_name+'/'+str(id))
            ...
            # .sort_values()
            words_categories = pd.read_csv('Anjali_BS_Extract/bsbankspkg/models/categories.csv',)['0']
            # categories
            words_model = tf.keras.models.load_model('Anjali_BS_Extract/bsbankspkg/models/'+model_name+'/'+str(id))
        ...
        # try:
            ...
            if(recalculate):
                ...
                keywords = pd.read_csv('Anjali_BS_Extract/bsbankspkg/keywords.csv')
            ...
            with open("Anjali_BS_Extract/bsbankspkg/global_percentiles.json", "r") as f:
            ...
            qt = load(open('Anjali_BS_Extract/bsbankspkg/qt.pkl', 'rb'))
            ...
            model = tf.keras.models.load_model(
                'Anjali_BS_Extract/bsbankspkg/models/lean/0.9384675110399379')
            labels = pd.read_csv('Anjali_BS_Extract/bsbankspkg/models/lean/labels')['0']
