...
T = TypeVar("T", bound="ApiOutputUnflashedPropertyResultResidual")


@attr.s(auto_attribs=True)
class ApiOutputUnflashedPropertyResultResidual:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_output_unflashed_property_result_residual = cls(
            volume=volume,
        ...
        return api_output_unflashed_property_result_residual
