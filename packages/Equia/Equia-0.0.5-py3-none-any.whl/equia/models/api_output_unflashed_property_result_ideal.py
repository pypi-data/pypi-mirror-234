...
T = TypeVar("T", bound="ApiOutputUnflashedPropertyResultIdeal")


@attr.s(auto_attribs=True)
class ApiOutputUnflashedPropertyResultIdeal:
    """Holds ideal values"""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_output_unflashed_property_result_ideal = cls(
            volume=volume,
        ...
        return api_output_unflashed_property_result_ideal
