...
async def get(
    ...
    Args:
        resource_id(str):
            Alb.application_profile unique ID.
...
async def create(
    ...
    Args:
        ...
        resource_id(str, Optional):
            Alb.application_profile unique ID. Defaults to None.
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.alb.application_profile.update resource_id=value, x_avi_version=value, type_=value
    """
