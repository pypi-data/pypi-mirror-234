...
def create_reader(
    ...
    if not datareader_qos.property.exists("dds.data_reader.history.generate_not_alive_no_writers_sample"):
        datareader_qos.property["dds.data_reader.history.generate_not_alive_no_writers_sample"] = "0"
