...
class Object:
    def __init__(self, client: "fipper.Client" = None):
        self._client = client

    def bind(self, client: "fipper.Client"):
        """Bind a Client instance to this and to all nested Fipper objects.
        ...
        Parameters:
            client (:obj:`~fipper.types.Client`):
                ...
                deserializing Fipper objects with ``repr`` and ``eval``.
        """
        self._client = client
