...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~fipper.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <fipper.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <fipper.raw.base.MessagePeerReaction>`, *optional*):
            N/A
