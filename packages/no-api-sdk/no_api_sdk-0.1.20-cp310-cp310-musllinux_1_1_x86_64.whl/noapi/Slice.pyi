...
class Slice:
    ...
    def __init__(self, of_list: List, localdb: dict, start_item: Optional['Item'], size: int, search_term: Optional[Union[str, float, 'Item']], search_field: Optional[str], internal: bool = ...) -> None: ...
    def __iter__(self) -> Union[islice, deque]: ...
    def forward(self, steps: Optional[int] = ...) -> None: ...
    def set_search(self, search_term: Union[str, int], search_field: Optional[str] = ...) -> None: ...
    def reset_search(self) -> None: ...
    def on_update(self, call_back: callable) -> None: ...
    def count(self) -> int: ...
    def set_size(self, new_size: int) -> None: ...
    def backward(self, steps: Optional[int] = ...) -> None: ...
