...
def get_pcrs_user_config():
    ...
    pcrs_multi_proc_batch_size = \
        get_attribute_from_config_settings('pcrs_multi_proc_batch_size', '500')
    etld_lib_functions.logger.info(f"pcrs_multi_proc_batch_size - {pcrs_multi_proc_batch_size}")

    pcrs_concurrency_limit = \
        get_attribute_from_config_settings('pcrs_concurrency_limit', '5')
    if int(pcrs_concurrency_limit) > 10:
        pcrs_concurrency_limit = '10'
    ...
    pcrs_limit_hosts = \
        get_attribute_from_config_settings('pcrs_limit_hosts', '500')
    ...
    pcrs_catalog_start_greater_than_last_id = \
        get_attribute_from_config_settings('pcrs_catalog_start_greater_than_last_id', 0)
