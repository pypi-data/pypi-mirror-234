...
#     pcrs_batch_status = {}
#     with etld_lib_config.pcrs_open_file_compression_method(json_file, "rt", encoding='utf-8') as read_file:
#         pcrs_dict = json.load(read_file)
#         if 'hasMore' in pcrs_dict.keys():
#             pcrs_batch_status = {
#                 'responseCode': pcrs_dict['responseCode'],
#                 'count': pcrs_dict['count'],
#                 'hasMore': pcrs_dict['hasMore'],
#                 'lastSeenAssetId': pcrs_dict['lastSeenAssetId'],
#                           }
#
#         if 'hasMore' not in pcrs_batch_status.keys():
#             etld_lib_functions.logger.error("Error downloading records")
#             etld_lib_functions.logger.error(f"pcrs_batch_status: {pcrs_batch_status}")
#             exit(1)
#
#     return pcrs_batch_status
...
# def get_pcrs_postureinfo_for_one_policy(pcrs_hostids_file:Path,
#                                         batch_queue_process,
#                                         batch_queue_of_file_paths,
#                                         max_batch_size=300):
...
#
#         if hostids_batch_counter >= int(max_batch_size):
#             hostids_batch_counter = 0
...
#             get_pcrs_postureinfo_for_batch_of_hostids(batch_number_and_slice_and_policy_str,
#                                                       policy_id,
#                                                       pcrs_hostids_template_dict,
#                                                       batch_queue_process,
#                                                       batch_queue_of_file_paths)
#             pcrs_hostids_template_dict = json.loads(pcrs_hostids_template_str)
#
