...
def create_aggregate_features(
    ...
    time_window_wrapper = TimeWindowWrapper.from_args(feature_aggregation.time_window)
    output_feature_name = feature_aggregation.name or feature_view_utils.construct_aggregation_output_feature_name(
        ...
        time_window=time_window_wrapper,
    ...
    return feature_view__data_pb2.AggregateFeature(
        ...
        time_window=feature_view__data_pb2.TimeWindow(
            window_start=time_utils.timedelta_to_proto(time_window_wrapper.window_start),
            window_end=time_utils.timedelta_to_proto(time_window_wrapper.window_end),
        ),
