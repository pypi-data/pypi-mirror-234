...
class TransportsApi:
    ...
    @validate_arguments
    def create_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(..., description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create transport  # noqa: E501
    ...
    @validate_arguments
    def delete_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove transport  # noqa: E501
    ...
    @validate_arguments
    def read_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Reading transport  # noqa: E501
    ...
    @validate_arguments
    def update_transport_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(..., description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update transport  # noqa: E501
