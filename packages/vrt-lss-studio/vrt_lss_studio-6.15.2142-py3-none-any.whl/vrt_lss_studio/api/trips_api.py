...
class TripsApi:
    ...
    @validate_arguments
    def create_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(..., description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Trip create  # noqa: E501
    ...
    @validate_arguments
    def delete_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove trip  # noqa: E501
    ...
    @validate_arguments
    def read_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read trip  # noqa: E501
    ...
    @validate_arguments
    def update_trip_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(..., description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Trip update  # noqa: E501
