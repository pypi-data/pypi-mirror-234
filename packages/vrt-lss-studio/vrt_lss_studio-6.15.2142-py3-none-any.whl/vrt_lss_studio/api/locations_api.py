...
class LocationsApi:
    ...
    @validate_arguments
    def create_location_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(..., description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create location  # noqa: E501
    ...
    @validate_arguments
    def delete_location_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove location  # noqa: E501
    ...
    @validate_arguments
    def read_location_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read location  # noqa: E501
    ...
    @validate_arguments
    def update_location_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(..., description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update location  # noqa: E501
