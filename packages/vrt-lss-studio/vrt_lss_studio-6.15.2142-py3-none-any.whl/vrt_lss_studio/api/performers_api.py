...
class PerformersApi:
    ...
    @validate_arguments
    def create_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_performer : Annotated[WebPerformer, Field(..., description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create performer  # noqa: E501
    ...
    @validate_arguments
    def delete_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove performer  # noqa: E501
    ...
    @validate_arguments
    def enable_performers_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable performers request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Enable performers  # noqa: E501
    ...
    @validate_arguments
    def read_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read performer  # noqa: E501
    ...
    @validate_arguments
    def update_performer_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_performer : Annotated[WebPerformer, Field(..., description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update performer  # noqa: E501
