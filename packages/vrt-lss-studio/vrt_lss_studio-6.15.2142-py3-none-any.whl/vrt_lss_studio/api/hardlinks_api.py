...
class HardlinksApi:
    ...
    @validate_arguments
    def create_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(..., description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create hardlink  # noqa: E501
    ...
    @validate_arguments
    def delete_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove hardlink  # noqa: E501
    ...
    @validate_arguments
    def enable_hardlinks_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], request_body : Annotated[conlist(constr(strict=True, max_length=1024, min_length=1), max_items=15001, min_items=0), Field(..., description="Enable hardlinks request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Enable hardlinks  # noqa: E501
    ...
    @validate_arguments
    def read_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], essence_key : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(..., description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read hardlink  # noqa: E501
    ...
    @validate_arguments
    def update_hardlink_with_http_info(self, experiment_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(..., description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update hardlink  # noqa: E501
