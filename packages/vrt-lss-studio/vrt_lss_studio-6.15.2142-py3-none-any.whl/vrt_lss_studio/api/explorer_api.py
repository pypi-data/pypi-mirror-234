...
class ExplorerApi:
    ...
    @validate_arguments
    def delete_folder_with_http_info(self, folder_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Folder key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Folder removal  # noqa: E501
    ...
    @validate_arguments
    def duplicate_folder_with_http_info(self, folder_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Folder key, unique identifier.")], folder_specification : Annotated[FolderSpecification, Field(..., description="Folder duplicate request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Folder duplicate  # noqa: E501
    ...
    @validate_arguments
    def read_filesystem_with_http_info(self, filter : Annotated[Optional[constr(strict=True, max_length=64, min_length=1)], Field(description="Filter for searching by text fields.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Getting a filesystem  # noqa: E501
    ...
    @validate_arguments
    def read_folder_with_http_info(self, folder_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Folder key, unique identifier.")], filter : Annotated[Optional[constr(strict=True, max_length=64, min_length=1)], Field(description="Filter for searching by text fields.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Experiment list  # noqa: E501
    ...
    @validate_arguments
    def update_folder_with_http_info(self, folder_key : Annotated[constr(strict=True, max_length=256, min_length=2), Field(..., description="Folder key, unique identifier.")], folder_specification : Annotated[FolderSpecification, Field(..., description="Folder update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update folder  # noqa: E501
