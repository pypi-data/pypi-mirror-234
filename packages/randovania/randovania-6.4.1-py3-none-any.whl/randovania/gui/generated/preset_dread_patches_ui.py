...
class Ui_PresetDreadPatches(object):
    def setupUi(self, PresetDreadPatches):
        ...
        self.scroll_contents.setGeometry(QRect(0, -238, 426, 544))
        ...
        self.nerf_power_bombs_label.setTextFormat(Qt.MarkdownText)
...
"\n"
"This setting removes the ability to destroy Enkies and open Charge Beam doors, making Ice Missiles and Charge Beam much more valuable. \n"
"\n"
"*Temporarily disabled in this version due to bugs. Please check again in a future release.*", None))
    # retranslateUi
