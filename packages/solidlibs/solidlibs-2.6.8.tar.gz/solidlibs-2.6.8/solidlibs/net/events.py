...
def get_entry(name, request=None, user_agent=None, when=None, details=None):
    ''' Build a simulated Apache log entry.
        ...
        Example log line:
        67.195.115.61 www.topdevpros.com/ - [08/Nov/2009:06:31:25 +0000] "GET /robots.txt HTTP/1.0" 301 0 "-" "Mozilla/5.0 (compatible; Yahoo! Slurp; http://help.yahoo.com/help/us/ysearch/slurp)"
