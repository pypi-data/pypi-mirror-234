...
from quart import Markup, url_for
...
class OptCol(Col):
    ...
    def __init__(
        self, name, choices=None, default_key=None, default_value="", coerce_fn=None, **kwargs
    ):
...
class BoolCol(OptCol):
    ...
    def __init__(self, name, yes_display=None, no_display=None, **kwargs):
        ...
        super(BoolCol, self).__init__(
            name, choices={True: yes_display, False: no_display}, coerce_fn=bool, **kwargs
        )
...
class BoolNaCol(OptCol):
    ...
    def __init__(self, name, yes_display=None, no_display=None, na_display=None, **kwargs):
        if yes_display is None:
            yes_display = self.yes_display
        if no_display is None:
            no_display = self.no_display
...
class LinkCol(Col):
    ...
    def url_kwargs(self, item):
        ...
        item_kwargs = {k: _recursive_getattr(item, v) for k, v in self._url_kwargs.items()}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(ButtonCol, self).__init__(
            name, endpoint, attr=attr, attr_list=attr_list, url_kwargs=url_kwargs, **kwargs
        )
