...
class Invoice(models.Model):
    ...
    salesman_id = models.IntegerField(verbose_name='业务员id', primary_key=False, help_text='')
    thread_id = models.IntegerField(verbose_name='合同ID（信息id）', primary_key=False, help_text='')
    dept_id = models.IntegerField(verbose_name='部门id', primary_key=False, help_text='')
