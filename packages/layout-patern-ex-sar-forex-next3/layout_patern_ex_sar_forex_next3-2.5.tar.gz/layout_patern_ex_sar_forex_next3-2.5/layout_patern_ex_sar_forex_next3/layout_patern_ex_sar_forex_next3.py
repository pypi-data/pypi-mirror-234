...
class Layout:
    ...
    def cal_layout(candel_num  , factor , min_3_5 , min_2_6 , max_3_5 , max_2_6 , status):
            ...
            if status == "true":       
                    ...
                    #    print("point_close6:" , point_close6)
                       ...
                       if type == "Head_Shoulder":
                             ...
                             Result_p3 = point_close4 - point_close3
                             Result_p3 = Layout.decimal(Result_p3 ,Layout().decimal_sambol)
                             Result_p3 = abs(Result_p3) 
                             print("Result_p3:" , Result_p3)
             
                             Result_p5 = point_close4 - point_close5
                             Result_p5 = Layout.decimal(Result_p5 ,Layout().decimal_sambol)
                             Result_p5 = abs(Result_p5) 
                             print("Result_p5:" , Result_p5)
                             ...
                             if Result_p5 > Result_p3:
                                   
                                   Result_end = Result_p5 / Result_p3
                                   Result_end = round(Result_end , 2)
                                   print("Result_end:" , Result_end)
             
                             elif Result_p3 > Result_p5:  
             
                                   Result_end = Result_p3 / Result_p5
                                   Result_end = round(Result_end , 2)
                                   print("Result_end:" , Result_end)   
                             
                             Result_p3 = float(Result_p3)
                             Result_p5 = float(Result_p5)

                             Result_p2 = float(Result_p2)
                             Result_p6 = float(Result_p6)
         
                             Result_p33 = int (Result_p3 * Layout.decimal_mov(Layout().decimal_sambol))
                             Result_p55 = int (Result_p5 * Layout.decimal_mov(Layout().decimal_sambol))
                             print("Result_p33:" , Result_p33)
                             print("Result_p55:" , Result_p55)

                             Result_p22 = int (Result_p2 * Layout.decimal_mov(Layout().decimal_sambol))
                             Result_p66 = int (Result_p6 * Layout.decimal_mov(Layout().decimal_sambol))
                             print("Result_p22:" , Result_p22)
                             print("Result_p66:" , Result_p66)

                             
                             if Result_end <= factor and Result_p22 >= min_2_6 and Result_p22 < max_2_6  and  Result_p33 >= min_3_5 and Result_p33 < max_3_5 and Result_p55 > min_3_5 and Result_p55 < max_3_5 and Result_p66 >= min_2_6 and Result_p66 < max_2_6:
