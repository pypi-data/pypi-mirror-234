...
def encrypt(msg:str, returnBytes:bool=False, pswd:str=_ECRYPTION_SALT) -> Union[str,bytes]:
    '''
...
def decrypt(encryptedMsg:str, returnBytes:bool=False, pswd:str=_ECRYPTION_SALT) -> Union[str,bytes]:
    try:
...
def hash(msg:Union[str,bytes], returnBytes:bool=False, salt:Union[str,bytes] = _HASH_SALT) -> Union[str,bytes]:
