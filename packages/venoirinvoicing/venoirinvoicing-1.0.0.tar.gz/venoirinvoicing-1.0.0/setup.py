...
setup(
  name = 'venoirinvoicing',         #* Your package will have this name
  packages = ['venoirinvoicing'],   #* Name the package again
  ...
  author = 'Maximilian Scheer',                   # Your name
  author_email = 'programming@venoir.de',  # Your email
