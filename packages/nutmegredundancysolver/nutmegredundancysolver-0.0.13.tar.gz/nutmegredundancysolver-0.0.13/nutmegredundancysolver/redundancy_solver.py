    ...
    while j <len(candidate_list):
        ...
        while k < len(candidate_list):
            ...
            if cand==next_cand:
                ...
                next_cand_id=ObjectId(str(next_cand.Id))
                #next_cand_id.generation_time=next_cand.Id.generation_time
                mongo_collection.update_one({"_id":next_cand_id},{"$set":{"IsDuplicate":True}})
                ...
                this_cand_id=ObjectId(str(cand.Id))
                #this_cand_id.generation_time=cand.Id.generation_time
                mongo_collection.update_one({"_id":this_cand_id},{ "$set":{
