...
from searchdatamodels import JsonableObjectId
import time
...
class RedundancySolverTest(unittest.TestCase):
    ...
    def test_merge_and_update_redundant_candidate_list(self):
        ...
        for returned_candidate in returned_candidate_dict_list:
            old_id=returned_candidate["_id"]
            returned_candidate["Id"]=JsonableObjectId(generation_time=old_id.generation_time, str_value=str(old_id))
