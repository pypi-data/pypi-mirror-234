...
class ValidateRateLimitPostgres:
    ...
    def validate_user_rate(self, user_id: str) -> ValidateRateLimitPostgres:
        if not ENABLE_RATE_LIMIT:
            return

        user_tier = self.get_user_tier(user_id)
        user_usage = self.get_user_rate_limit_usage(user_id)
    ...
    @abstractmethod
    def get_user_rate_limit_usage(self, user_id: str) -> int:
        ...

    @abstractmethod
    def increment_user_rate_usage(self, user_id: str, usage: int) -> int:
        ...