...
class WrappedRecordModel(ABC):
    ...
    def add(self, adder: AbstractRecordModelPropertyAdder[RecordModelPropertyType]) -> None:
        """
        Add a value to a property, assuming the property itself is an iterable type.
        """
        return adder.add_value(self._backing_model)

    def remove(self, remover: AbstractRecordModelPropertyRemover[RecordModelPropertyType]) -> None:
        """
    ...
    def set(self, setter: AbstractRecordModelPropertySetter[RecordModelPropertyType]) -> None:
        """
