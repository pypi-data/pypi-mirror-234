...
"""
        ...
        orb_input_selection = (
            "*".lower().replace("angle", "angel").split(",")
        )
...
def edit_talent_orbs(save_stats: dict[str, Any], item_amount) -> dict[str, Any]:
