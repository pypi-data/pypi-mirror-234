...
def specific_id_stages(save_stats: dict[str, Any], stage_id : str):
    """Handler for editing specific stages"""

    treasure_stats = save_stats["treasures"]
    stage_id = int(stage_id) - 1
    chapter_ids = [int(stage_id)]
    ...
    for chapter_id in chapter_ids:
        ...
        stage_ids = story_level_id_selector.select_levels(chapter_id, choice)
        treasure_data = [-1] * 48
        treasure_data = [3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3]
        treasure_stats = set_specific_treasures(
            treasure_stats, treasure_data, chapter_id
        )
        print(treasure_data)
