...
class UserApplyApis(APIView):
    ...
    def add_user_apply(self, *args, request_params, user_info, **kwargs):
        ...
        filter_verify = ['real_name', 'id_card', "id_card_front", "id_card_back", "qualification_certificate"]
        verify_files = {k: v for k, v in request_params.items() if k in filter_verify}
        request_params['verify_files'] = verify_files
