...
def demo_vis_CocoInstances():
    anno_file1 = "/home/PKing/nasdata/dataset-dmai/AIJE/dataset/aije-outdoor-det/dataset-v1/train-coco.json"
    anno_file2 = "/home/PKing/nasdata/dataset-dmai/AIJE/dataset/aije-outdoor-det/dataset-v2/train-coco.json"
    ...
    dataset = parser_coco_ins.CocoInstances(anno_file=[anno_file1,anno_file2], image_dir="",
