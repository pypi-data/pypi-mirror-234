...
class SessionStorage:
    ...
    def setItem(self, itemKey:str=None, itemValue:Union[str, int, float, bool]=None, key:str="set"):
        ...
        try:
            self.sessionBrowserStorageManager(method="setItem", itemKey=itemKey, itemValue=itemValue, key=key)
            return True
        except:
            return False   
    ...
    def deleteItem(self, itemKey:str, key:str="deleteItem"): 
        ...
        self.sessionBrowserStorageManager(method="deleteItem", itemKey=itemKey, key=key) 
        
        return True
    
    def eraseItem(self, itemKey:str, key:str="eraseItem"):
        """
        ...
        self.sessionBrowserStorageManager(method="eraseItem", itemKey=itemKey, key=key) 
    ...
    def getItem(self, itemKey:str=None, key:str="get"):
        ...
        saved_key = self.sessionBrowserStorageManager(method="getItem", itemKey=itemKey, key=key) 
        return saved_key
