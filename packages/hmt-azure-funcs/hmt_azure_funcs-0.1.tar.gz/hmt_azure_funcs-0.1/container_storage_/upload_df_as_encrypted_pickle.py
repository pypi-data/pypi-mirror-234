...
connection_string = 'DefaultEndpointsProtocol=https;AccountName=hmtukshawkeyedatalakedev;AccountKey=lG8ER8LaGyUdvYDmt4cEwYRmChC+pD05O20RoJkKNFFxYJUGSAy7KXcVg+b0Y/cmF+qF/acBSYKi+AStpmbXDg==;EndpointSuffix=core.windows.net'
container_name = 'test'
blob_name = 'example.pickle'

upload_df_as_encrypted_pickle(
    department_code_to_forecasts_and_features[department_code],
    connection_string, 
    container_name, 
    blob_name,
    key_string,
