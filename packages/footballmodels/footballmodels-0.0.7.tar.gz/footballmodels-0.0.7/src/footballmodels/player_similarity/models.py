...
from footballmodels.utils.distance import weighted_cartesian_distance, weighted_l1_distance
import numpy as np
...
class SimilarityAlgorith(ABC):
    ...
    def find(self, player: str, squad: str, season: int, comp: str, n: int = 10, filter_kwargs: dict = None):
