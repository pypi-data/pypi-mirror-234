...
class PMBaseAIModel:
    def __init__(self, config, params_define):
        ...
        self._error_messge_path = model_path_dict['error_message_path']
    ...
    def request(self, requestBody, params=None):
        ...
        if stream:
            return PMBaseAIModel.request_stream(self, requestBody, params)
        else:
    ...
    def request_stream(self, requestBody, params=None):
        config = self.config
        params_define = self.params_define
...
class PMLLM(PMBaseAIModel):
    ...
    def get_model_path_dict(config, params_define):
        ...
        content_path = PMBaseAIModel.get_response_path(responseBody, '${result_context}')
