...
def send_mobile_phone_verification_code_sms(mobile_phone, verification_code, request_id):
    message = '{mobile_app} {request_id}-{verification_code} is your Verification Code. It will be expired after {expiry_in_minute} minutes'.format(mobile_app='MemberAsia', verification_code=verification_code, 
                       request_id = request_id, 
