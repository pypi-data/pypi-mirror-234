...
class ManagedGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param auth_method_id: The resource ID for the auth method. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group#auth_method_id ManagedGroup#auth_method_id}
        :param filter: Boolean expression to filter the workers for this managed group. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group#filter ManagedGroup#filter}
        :param description: The managed group description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group#description ManagedGroup#description}
        :param name: The managed group name. Defaults to the resource name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group#name ManagedGroup#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
