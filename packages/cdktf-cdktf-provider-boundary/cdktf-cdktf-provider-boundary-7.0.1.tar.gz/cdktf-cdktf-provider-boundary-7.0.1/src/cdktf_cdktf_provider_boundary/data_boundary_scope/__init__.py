...
class DataBoundaryScope(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the scope to retrieve. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/data-sources/scope#name DataBoundaryScope#name}
        :param scope_id: The parent scope ID that will be queried for the scope. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/data-sources/scope#scope_id DataBoundaryScope#scope_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
