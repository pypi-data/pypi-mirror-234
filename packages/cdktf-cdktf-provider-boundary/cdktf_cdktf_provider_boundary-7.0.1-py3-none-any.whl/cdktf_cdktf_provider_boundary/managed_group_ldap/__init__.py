...
class ManagedGroupLdap(
    ...
    def __init__(
        ...
        *,
        ...
        :param auth_method_id: The resource ID for the auth method. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group_ldap#auth_method_id ManagedGroupLdap#auth_method_id}
        :param group_names: The list of groups that make up the managed group. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group_ldap#group_names ManagedGroupLdap#group_names}
        :param description: The managed group description. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group_ldap#description ManagedGroupLdap#description}
        :param name: The managed group name. Defaults to the resource name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/boundary/1.1.10/docs/resources/managed_group_ldap#name ManagedGroupLdap#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
