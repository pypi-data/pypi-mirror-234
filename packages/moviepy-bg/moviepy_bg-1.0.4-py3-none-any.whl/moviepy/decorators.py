...
def use_clip_fps_by_default(f, clip, *a, **k):
    ...
    if f.__name__ == "write_videofile" and not a[4]:
        names = ["filename", "fps", "codec", "bitrate", "audio", "audio_fps",
                                "preset",
                                "audio_nbytes", "audio_codec",
                                "audio_bitrate", "audio_bufsize",
                                "temp_audiofile",
                                "rewrite_audio", "remove_temp",
                                "write_logfile", "verbose",
                                "threads", "ffmpeg_params",
                                "logger"]
    else:
