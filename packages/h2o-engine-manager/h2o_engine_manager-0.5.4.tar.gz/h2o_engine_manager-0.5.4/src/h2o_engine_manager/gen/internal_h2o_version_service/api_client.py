...
from h2o_engine_manager.gen.internal_h2o_version_service import rest
from h2o_engine_manager.gen.internal_h2o_version_service.configuration import Configuration
from h2o_engine_manager.gen.internal_h2o_version_service.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_engine_manager.gen.internal_h2o_version_service.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = InternalH2OVersionServiceApi()
        api_instance.internal_h2_o_version_service_create_internal_h2_o_version  # this is an instance of the class Endpoint
        api_instance.internal_h2_o_version_service_create_internal_h2_o_version()  # this invokes api_instance.internal_h2_o_version_service_create_internal_h2_o_version.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.internal_h2_o_version_service_create_internal_h2_o_version.callable or self.callable in this class
