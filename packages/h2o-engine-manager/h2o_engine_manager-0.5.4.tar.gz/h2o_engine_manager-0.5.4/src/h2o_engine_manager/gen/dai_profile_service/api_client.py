"""
    ai/h2o/engine/v1/dai_profile_service.proto
...
from h2o_engine_manager.gen.dai_profile_service import rest
from h2o_engine_manager.gen.dai_profile_service.configuration import Configuration
from h2o_engine_manager.gen.dai_profile_service.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_engine_manager.gen.dai_profile_service.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DAIProfileServiceApi()
        api_instance.d_ai_profile_service_create_dai_profile  # this is an instance of the class Endpoint
        api_instance.d_ai_profile_service_create_dai_profile()  # this invokes api_instance.d_ai_profile_service_create_dai_profile.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.d_ai_profile_service_create_dai_profile.callable or self.callable in this class
