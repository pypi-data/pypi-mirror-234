...
R1v1::Event* events_data[NUM_PREALLOCATED_EVENTS];
...
int main(int argc, char** argv)
{
    ...
    R1v1::TelescopeDataStream stream_metadata;
    R1v1::CameraConfiguration camera_config;
