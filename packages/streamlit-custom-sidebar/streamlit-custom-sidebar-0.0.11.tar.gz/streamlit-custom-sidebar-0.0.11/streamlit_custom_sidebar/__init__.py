        ...
        js_el = f'''
                    ...
                    <script>
                        ...
                        if (sidebar.length < 1){{
                            ...
                            let iframeScreenComp = window.parent.document.querySelectorAll('iframe[srcdoc*="sidebar"]')
    ...
    def close_sidebar(self):
        ...
        js_el = f'''
                    <script>
                            ...
                            let iframeScreenComp = window.parent.document.querySelectorAll('iframe[srcdoc*="closeSidebar"]')
                            iframeScreenComp[0].parentNode.style.display = "none";
                    </script>
                '''
        st.components.v1.html(js_el, height=0, width=0)
    ...
    def open_sidebar(self):
        ...
        js_el = f'''
                    <script>
                            ...
                            let iframeScreenComp = window.parent.document.querySelectorAll('iframe[srcdoc*="openSidebar"]')
                            iframeScreenComp[0].parentNode.style.display = "none";
                    </script>
                '''
        st.components.v1.html(js_el, height=0, width=0)
    ...
    def cleanApp(self):
        ...
        jse_el = '''
                    <script>
                        ...
                        let iframeScreenStyle = window.parent.document.querySelectorAll('div[data-testid="stMarkdownContainer"] > style')
                        iframeScreenStyle[0].parentNode.parentNode.parentNode.style.display = "none";

                        let iframeScreenStyle = window.parent.document.querySelectorAll('iframe[srcdoc="iframeScreenComp"]' > style')
                        iframeScreenStyle[0].parentNode.style.display = "none";
