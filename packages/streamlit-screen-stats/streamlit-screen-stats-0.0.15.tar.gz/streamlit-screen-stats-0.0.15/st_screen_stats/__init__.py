...
class SizeRange:
    ...
    def WidthRange(self, upperRange=None, key=None, default=None):

        value = _st_screen_data(windowType="windowRange", heightWidth="width", upperRange=upperRange, key=key, default=default)
