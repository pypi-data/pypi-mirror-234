...
class ActionDoneEvent(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["action_external_id", b"action_external_id", "action_outcome", b"action_outcome", "action_report_id", b"action_report_id"]) -> None: ...
