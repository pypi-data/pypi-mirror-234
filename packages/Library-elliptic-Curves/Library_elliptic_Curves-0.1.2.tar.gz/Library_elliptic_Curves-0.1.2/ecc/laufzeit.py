...
def laufzeit_prim(p1,p2,n):
    Kurve = getrandomcurve.get_randomcurve(p1,n,"no")
    Kurve2= getrandomcurve.get_randomcurve(p2,n,"no")
...
def laufzeit_degree(n1,n2,p):
    Kurve = getrandomcurve.get_randomcurve(p,n1,"no")
    Kurve2= getrandomcurve.get_randomcurve(p,n2,"no")
    a = (laufzeit_q(Kurve,Kurve.q))
    b = (laufzeit_q(Kurve2,Kurve2.q))
    print(a,b,a/b,n1/n2)
