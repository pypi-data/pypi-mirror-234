...
class Distances(Data_sequence):
    def __init__(self, trajectory: Trajectories = None, trajectory2: Trajectories = None, locations: Location_list = None, locations2: Location_list = None):
