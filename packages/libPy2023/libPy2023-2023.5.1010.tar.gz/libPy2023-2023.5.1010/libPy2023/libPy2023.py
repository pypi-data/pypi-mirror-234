...
def emailSender(xTo ,Asunto="TEST", xBody="Hola Mundo",xServer="Outlook",adjunto=""):
    ...
    for addr_to in xTo:
        ...
        if xServer=="Outlook":
            ...
            PassWord=PASS_CLB   
        if xServer=="gmail":
            User_email=USER_EMAIL_GMAIL 
            PassWord=USER_PASS_GMAIL

        addr_from = USER_EMAIL_GMAIL if xServer=="gmail" else User_email
        ...
        smtp_user   = USER_EMAIL_GMAIL if xServer=="gmail" else User_email
        smtp_pass   = USER_PASS_GMAIL  if xServer=="gmail" else PassWord
