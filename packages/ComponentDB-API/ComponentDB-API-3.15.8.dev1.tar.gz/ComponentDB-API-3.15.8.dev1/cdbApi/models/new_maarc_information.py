...
class NewMAARCInformation(object):
    ...
    def __init__(self, name=None, description=None, entity_type_list=None, item_projects_list=None, owner_user=None, owner_group=None, parent_item_id=None, parent_element_name=None, local_vars_configuration=None):  # noqa: E501
