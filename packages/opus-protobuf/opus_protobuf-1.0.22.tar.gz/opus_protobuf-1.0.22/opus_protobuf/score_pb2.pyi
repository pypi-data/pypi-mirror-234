...
class Authority(_message.Message):
    __slots__ = ["industry", "value"]
    INDUSTRY_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    industry: str
    value: int
    def __init__(self, industry: _Optional[str] = ..., value: _Optional[int] = ...) -> None: ...

class Industries(_message.Message):
    __slots__ = ["authority"]
    AUTHORITY_FIELD_NUMBER: _ClassVar[int]
    authority: _containers.RepeatedCompositeFieldContainer[Authority]
    def __init__(self, authority: _Optional[_Iterable[_Union[Authority, _Mapping]]] = ...) -> None: ...
