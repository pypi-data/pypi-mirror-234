...
class MultiprocessingManager:
    ...
    def __init_workers(self):
        ...
        high_threads = os.environ["project_x_high_threads"] if "project_x_high_threads" in os.environ else False
        if debug == "true":
            worker_count = 1
        elif high_threads == "true":
            worker_count = 96
        else:
            worker_count = max(multiprocessing.cpu_count() - 2, 1)
