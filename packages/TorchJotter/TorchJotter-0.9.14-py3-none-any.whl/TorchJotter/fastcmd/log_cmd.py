"""
Usage:
    TorchJotter log <log-dir> [--log-config-name=L] [--port=P] [--standby-hours=S] [--token=T] [--ip=I]

Arguments:
    log-dir                 Where to find logs.

Options:
    -h --help               This is a command to start TorchJotter server to visualize logs.
...
import os
from TorchJotter.fastserver.app import start_app
