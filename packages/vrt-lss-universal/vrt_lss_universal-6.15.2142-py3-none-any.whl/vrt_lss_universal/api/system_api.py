...
class SystemApi:
    ...
    @validate_arguments
    def file_with_http_info(self, filename : Annotated[constr(strict=True, max_length=128, min_length=6), Field(..., description="File name.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Getting the documentation  # noqa: E501
