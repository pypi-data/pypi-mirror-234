...
class Installer:
    ...
    def load_demo_pipelines(self, demo_name, demo_conf: DemoConf, debug=False):
        ...
        for pipeline in demo_conf.pipelines:
            ...
            if self.db.conf.is_dev_env() or self.db.conf.is_demo_env():
                if self.db.conf.is_dev_env():
                    cluster["instance_pool_id"] = "0213-111033-rowed79-pool-zb80houq"
                else:
                    cluster["instance_pool_id"] = "0727-104344-hauls13-pool-uftxk0r6"
