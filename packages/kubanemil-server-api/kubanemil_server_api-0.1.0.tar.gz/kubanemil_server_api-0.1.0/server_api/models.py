...
from .utils import create_status, create_msg
...
class ApplicationRead(BaseModel):
    ...
    @property
    def pull_api_collector_status(self):
    ...
    @property
    def push_api_integration_check_status(self):
...
class EventRead(TargetBase):
    ...
    @property
    def s2s_events_sender_status(self):
...
class ModelRead(BaseModel):
    ...
    @property
    def model_manager_fit_status(self):
...
class PipelineRead(BaseModel):
    ...
    @property
    def data_transformer_train_status(self):
    ...
    @property
    def data_transformer_inference_status(self):
