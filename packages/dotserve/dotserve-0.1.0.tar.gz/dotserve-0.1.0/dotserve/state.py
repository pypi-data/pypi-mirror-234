"""Define the dotserve state specification."""
...
from dotserve.utils import format, prerequisites, types
from dotserve.utils.exceptions import ImmutableStateError, LockExpiredError
from dotserve.vars import BaseVar, ComputedVar, Var
...
class State(Base, ABC, extra=pydantic.Extra.allow):
    ...
    def _get_base_functions() -> dict[str, FunctionType]:
        ...
        Returns:
            The functions of ds.State class as a dict.
        """
        return {
            func[0]: func[1]
    ...
    async def set_state(self, token: str, state: State, lock_id: bytes | None = None):
        ...
        if (
            ...
            raise LockExpiredError(
                ...
                "or use `@ds.background` decorator for long-running tasks."
            )
