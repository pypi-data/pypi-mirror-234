...
from dotserve.components.tags import Tag
from dotserve.constants import Dirs, EventTriggers
...
from dotserve.utils import console, format, imports, types
from dotserve.vars import BaseVar, ImportVar, Var


class Component(Base, ABC):
    """The base class for all Dotserve components."""
    ...
    def __str__(self) -> str:
        ...
        Returns:
            The code to render the component.
        """
        from dotserve.compiler.compiler import _compile_component
    ...
    def create(cls, *children, **props) -> Component:
        ...
        for child in children:
            ...
            if not types._isinstance(child, ComponentChild):
                raise TypeError(
                    "Children of Dotserve components must be other components, "
