"""Templates to use in the dotserve compiler."""
...
class DotserveJinjaEnvironment(Environment):
...
def get_template(name: str) -> Template:
    ...
    Returns:
        A render function.
    """
    return DotserveJinjaEnvironment().get_template(name=name)


# Template for the Dotserve config file.
