...
This script generates the element classes in the dotserve.el.elements module.
Run as follows:

    python -m dotserve.el.precompile
...
from dotserve.utils import path_ops
...
INIT_PY = [
    ...
    "",
    "from dotserve.el.element import Element",
    "from dotserve.vars import Var as Var_",
    "",
]
