...
from dotserve.components.graphing.recharts.general import ResponsiveContainer
...
class ChartBase(RechartsCharts):
    ...
    # If any two categorical charts(ds.line_chart, ds.area_chart, ds.bar_chart, ds.composed_chart) have the same sync_id, these two charts can sync the position GraphingTooltip, and the start_index, end_index of Brush.
    sync_id: Var[str]
