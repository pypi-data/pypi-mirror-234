    ...
    def create(
        ...
        **props
        ...
        Args:
            ...
            left_icon (Optional[Component]): Should be a ds.TagLeftIcon instance.
            right_icon (Optional[Component]): Should be a ds.TagRightIcon instance.
            close_button (Optional[Component]): Should be a ds.TagCloseButton instance.
