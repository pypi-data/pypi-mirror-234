...
from dotserve.utils import exceptions, serializers, types
from dotserve.utils.serializers import serialize
from dotserve.vars import Var

if TYPE_CHECKING:
    from dotserve.components.component import ComponentStyle
    from dotserve.event import EventChain, EventHandler, EventSpec
...
def format_prop(
    ...
    from dotserve.event import EVENT_ARG, EventChain
