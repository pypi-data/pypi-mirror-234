...
from dotserve.utils import console, path_ops, prerequisites, processes
from dotserve.utils.watch import AssetFolderWatch
...
def output_system_info():
    ...
    dependencies = [
        f"[Dotserve {constants.Dotserve.VERSION} with Python {platform.python_version()} (PATH: {sys.executable})]",
