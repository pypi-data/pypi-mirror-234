...
class Dirs(SimpleNamespace):
    """Various directories/paths used by Dotserve."""
...
class Dotserve(SimpleNamespace):
    """Base constants concerning Dotserve."""

    # App names and versions.
    # The name of the Dotserve package.
    MODULE_NAME = "dotserve"
    # The current version of Dotserve.
    VERSION = metadata.version(MODULE_NAME)

    # The dotserve json file.
    JSON = os.path.join(Dirs.WEB, "dotserve.json")

    # Files and directories used to init a new project.
    # The directory to store dotserve dependencies.
    DIR = (
        # on windows, we use C:/Users/<username>/AppData/Local/dotserve.
        # on macOS, we use ~/Library/Application Support/dotserve.
        # on linux, we use ~/.local/share/dotserve.
        PlatformDirs(MODULE_NAME, False).user_data_dir
    )
    # The root directory of the dotserve library.
...
class Templates(SimpleNamespace):
    ...
    class Dirs(SimpleNamespace):
        """Folders used by the template system of Dotserve."""

        # The template directory used during dotserve init.
        BASE = os.path.join(Dotserve.ROOT_DIR, Dotserve.MODULE_NAME, ".templates")
...
SKIP_COMPILE_ENV_VAR = "__DOTSERVE_SKIP_COMPILE"
