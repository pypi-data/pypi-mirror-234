...
class DefaultPage(SimpleNamespace):
    ...
    # The default title to show for Dotserve apps.
    TITLE = "Dotserve App"
    # The default description to show for Dotserve apps.
    DESCRIPTION = "A Dotserve app."
    # The default image to show for Dotserve apps.
    IMAGE = "favicon.ico"
    # The default meta list to show for Dotserve apps.
    META_LIST = []
