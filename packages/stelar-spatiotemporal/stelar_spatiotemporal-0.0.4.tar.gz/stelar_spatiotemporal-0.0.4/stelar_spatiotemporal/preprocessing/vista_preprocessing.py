from ..lib import check_types, save_bbox, get_filesystem
import numpy as np
import pandas as pd
import os
import glob
...
from ..segmentation.bands_data_package import BandsDataPackage
...
def unpack_vista_reflectance(bands_data_package:BandsDataPackage, 
                             crs:CRS = CRS(32630)):
    ...
    for band_data_package in bands_data_package.tolist():
        ...
        for ras_path, rhd_path in band_data_package.path_pairs:
            unpack_vista_unzipped(ras_path, rhd_path, band_data_package.BAND_PATH, crs=crs)
