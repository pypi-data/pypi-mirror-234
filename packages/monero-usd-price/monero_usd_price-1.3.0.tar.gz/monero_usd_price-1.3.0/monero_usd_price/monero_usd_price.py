...
def calculate_monero_from_usd(usd_amount, print_price_to_console=False, monero_price=False):
    if not monero_price:
        monero_price = median_price(print_price_to_console=print_price_to_console)
    else:
        monero_price = float(monero_price)
...
def calculate_usd_from_monero(monero_amount, print_price_to_console=False, monero_price=False):
    if not monero_price:
        monero_price = median_price(print_price_to_console=print_price_to_console)
    else:
        monero_price = float(monero_price)
...
def calculate_usd_from_atomic_units(atomic_units, print_price_to_console=False, monero_price=False):
    if not monero_price:
        monero_price = median_price(print_price_to_console=False)
    else:
        monero_price = float(monero_price)

    monero_amount = calculate_monero_from_atomic_units(atomic_units=atomic_units)
...
def calculate_atomic_units_from_usd(usd_amount, print_price_to_console=False, monero_price=False):
    monero_amount = calculate_monero_from_usd(usd_amount=usd_amount, print_price_to_console=False, monero_price=monero_price)
    atomic_units = calculate_atomic_units_from_monero(monero_amount=monero_amount)
    if print_price_to_console:
        print(atomic_units)
    return atomic_units
