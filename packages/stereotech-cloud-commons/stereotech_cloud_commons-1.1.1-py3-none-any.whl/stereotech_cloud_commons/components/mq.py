...
class PublisherConsumer:
    def __init__(self, ampq_url: str, exchange: str, queue: str, routing_keys: List[str], on_message_cb: Callable) -> None:
        # Connection specific
    ...
    def _on_message(self, unused_channel: Channel, basic_deliver: Basic.Deliver, properties: BasicProperties, body: bytes):
        ...
        self._on_message_cb(json.loads(body))
...
class MqService:
    def __init__(self, config: ConfigHelper) -> None:
        ...
        self.pub_con = PublisherConsumer(self.amqp_url, self.amqp_exchange, self.amqp_consume_queue,
                                         self.amqp_consume_keys, self.on_message)
        self.pub_con.connect()
