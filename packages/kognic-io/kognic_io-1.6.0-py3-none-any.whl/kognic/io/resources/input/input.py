...
class InputResource(IOResource):
    ...
    @deprecated_parameter("input_uuids", "scene_uuids", end_version="2.0.0")
    ...
    @deprecated_parameter("input_uuid", "scene_uuid", end_version="2.0.0")
    ...
    @deprecated_parameter("input_uuids", "scene_uuids", end_version="2.0.0")
    def get_inputs_by_uuids(self, scene_uuids: List[str]) -> List[Input]:
        """
