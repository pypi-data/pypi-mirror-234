...
with open("/Users/anjalimallissery/Downloads/Anjali_BS_Extract_SAU/requirements.txt") as f:
...
setup(
    ...
    description=("This repository contains a Python program designed to extract Optical Character Recognition (OCR)"
                 " data from bank statements in Saudi, detect income and classify expenses"),
