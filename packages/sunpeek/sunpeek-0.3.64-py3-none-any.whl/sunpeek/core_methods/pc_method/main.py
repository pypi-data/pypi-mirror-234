...
METHOD_DESCRIPTION = 'Thermal Power Check according to ISO 24194'
...
class PCMethod(ABC):
    ...
    @classmethod
    def from_method(cls,
                    method: AvailablePCMethods | str,
                    plant: Plant,
                    formula: AvailablePCFormulae | int,
                    use_wind: bool = True,
                    **kwargs):

        method = AvailablePCMethods(method)
        if method == AvailablePCMethods.iso:
