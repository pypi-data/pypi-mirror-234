...
# __version__ = '1.0.0'
# from ecometpy import __version__
# from ecometpy.version import version as __version__

from ecometpy.version import get_versions
...
name = 'ecometpy'
description = "ecometpy Library for FENGYUN Satellite "
...
setup(
    ...
    url='https://github.com/libin033/ecometpy',
    keywords=['FengYun', 'Meteorology', 'RemoteSensing'], # 关键词之间空格相隔一般
    # 需要安装的依赖
    namespace_packages = ['ecometpy'],
    install_requires = [
        'numpy >= 1.2.0',
        'h5py >= 1.0.0',
        'netcdf4 >= 1.0.0',
