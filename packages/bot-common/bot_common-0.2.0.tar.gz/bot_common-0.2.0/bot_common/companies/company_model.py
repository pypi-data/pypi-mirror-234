...
class ConfigObject(BaseModel):
    company: str =                                      Field(description="VARCHAR(250) NOT NULL <U_IDX> <IDX>")
    ...
    sessions_expiration_mins: int =                     Field(description="INT")
...
class FlowObject(BaseModel):
    in_ctx: str =               Field(description="VARCHAR(250) NOT NULL <U_IDX> <IDX>")
    intent: str =               Field(description="VARCHAR(250) <U_IDX>")
    entity: str =               Field(description="VARCHAR(250) <U_IDX>")
    action: str =               Field(description="TEXT")
    action_out: str =           Field(description="VARCHAR(250) <U_IDX>")
...
class ResponsesObject(BaseModel):
    id: str =       Field(description="VARCHAR(250) NOT NULL <U_IDX> <IDX>")
