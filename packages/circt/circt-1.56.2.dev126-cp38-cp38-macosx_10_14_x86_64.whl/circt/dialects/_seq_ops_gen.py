...
class CompRegClockEnabledOp(_ods_ir.OpView):
  ...
  def __init__(self, input, clk, clockEnable, name, *, reset=None, resetValue=None, powerOnValue=None, inner_sym=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CompRegOp(_ods_ir.OpView):
  ...
  def __init__(self, input, clk, name, *, reset=None, resetValue=None, powerOnValue=None, inner_sym=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
