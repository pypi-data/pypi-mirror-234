...
#    chunk.to_pickle(f"./assets/lm_ss_data1/ss_data_{str(i).zfill(8)}.pkl")
...
video_schema.add("complexEvent", EventInferenceSchemaElement(model="Complex-Vienna-Stop-Event"))
video_schema.add("productionEvent", EventInferenceSchemaElement(model="Production-Vienna-Stop-Event"))
...
# paths = []
# folder_path = "./assets/lm_ss_data1"
...
#                       name="stopsign-event-img-ds-full-v1", 
#                       type=DATASET_TYPE.IMAGE,
#                       data=df, 
#                       schema=image_ds_schema, 
#                       creds=creds)
