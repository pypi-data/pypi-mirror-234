...
ImportAddOnsTypeLiteral = Literal[
    "BIG_QUERY", "SNOWFLAKE", "GA_4", "GMC_PRICE_COMP_DATA", "UPDATE_FREQUENCY_EVERY_HOUR", "UPDATE_FREQUENCY_EVERY_MIN"
]
...
ChannelType = Union[BaseChannelType, ChannelAddOnsType]
...
BaseChannelTypeLiteral = Literal[
    ...
    'outbrain', 'price_asset'
]

ChannelAddOnsTypeLiteral = Literal[
    'dsa', 'local_inventory_feed', 'local_inventory_push',
