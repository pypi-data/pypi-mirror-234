...
# Warning: this dict is not complete!!!
num_valence = {1:1,2:2,3:3,4:2,5:3,6:4,7:5,8:6,9:7,10:8,11:9,12:8,13:3,14:4,15:5,
                                16:6,17:7,18:8,19:9,20:10,42:14,83:15,34:6,24:14,53:7,52:16,28:18,35:7,26:14,77:15,25:15,52:16}
    ...
    for ik in range(nk):
        ...
        if rank == 0:
            ...
            if normalization:
                ...
                lamda = np.einsum('ai, ij, aj -> a', np.conj(wfn), SK0, wfn).real
