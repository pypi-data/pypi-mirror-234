...
class AuthServerClaim(
    ...
    def __init__(
        ...
        *,
        ...
        :param auth_server_id: Auth server ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#auth_server_id AuthServerClaim#auth_server_id}
        :param claim_type: Specifies whether the claim is for an access token ``RESOURCE`` or ID token ``IDENTITY``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#claim_type AuthServerClaim#claim_type}
        :param name: Auth server claim name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#name AuthServerClaim#name}
        :param value: The value of the claim. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#value AuthServerClaim#value}
        :param always_include_in_token: Specifies whether to include claims in token, by default it is set to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#always_include_in_token AuthServerClaim#always_include_in_token}
        :param group_filter_type: Specifies the type of group filter if ``value_type`` is ``GROUPS``. Can be set to one of the following ``STARTS_WITH``, ``EQUALS``, ``CONTAINS``, ``REGEX``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#group_filter_type AuthServerClaim#group_filter_type}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#id AuthServerClaim#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param scopes: Auth server claim list of scopes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#scopes AuthServerClaim#scopes}
        :param status: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#status AuthServerClaim#status}.
        :param value_type: The type of value of the claim. It can be set to ``EXPRESSION`` or ``GROUPS``. It defaults to ``EXPRESSION``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/auth_server_claim#value_type AuthServerClaim#value_type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
