...
class AdminRoleCustom(
    ...
    def __init__(
        ...
        *,
        ...
        :param description: A human-readable description of the new Role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_custom#description AdminRoleCustom#description}
        :param label: The name given to the new Role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_custom#label AdminRoleCustom#label}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_custom#id AdminRoleCustom#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param permissions: The permissions that the new Role grants. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/admin_role_custom#permissions AdminRoleCustom#permissions}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
