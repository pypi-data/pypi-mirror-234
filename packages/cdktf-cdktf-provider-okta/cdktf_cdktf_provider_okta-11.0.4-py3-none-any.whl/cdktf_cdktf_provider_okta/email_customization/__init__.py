...
class EmailCustomization(
    ...
    def __init__(
        ...
        *,
        ...
        :param brand_id: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#brand_id EmailCustomization#brand_id}
        :param template_name: Template Name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#template_name EmailCustomization#template_name}
        :param body: The body of the customization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#body EmailCustomization#body}
        :param force_is_default: Force is_default on the create and delete by deleting all email customizations. Comma separated string with values of 'create' or 'destroy' or both `create,destroy'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#force_is_default EmailCustomization#force_is_default}
        :param is_default: Whether the customization is the default. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#is_default EmailCustomization#is_default}
        :param language: The language supported by the customization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#language EmailCustomization#language}
        :param subject: The subject of the customization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/resources/email_customization#subject EmailCustomization#subject}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
