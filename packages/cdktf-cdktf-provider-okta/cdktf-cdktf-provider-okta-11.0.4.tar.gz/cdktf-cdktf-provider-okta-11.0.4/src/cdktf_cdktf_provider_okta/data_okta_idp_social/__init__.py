...
class DataOktaIdpSocial(
    ...
    def __init__(
        ...
        *,
        ...
        :param id: The id of the social idp to retrieve, conflicts with ``name``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/data-sources/idp_social#id DataOktaIdpSocial#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param name: The name of the social idp to retrieve, conflicts with ``id``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/data-sources/idp_social#name DataOktaIdpSocial#name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
