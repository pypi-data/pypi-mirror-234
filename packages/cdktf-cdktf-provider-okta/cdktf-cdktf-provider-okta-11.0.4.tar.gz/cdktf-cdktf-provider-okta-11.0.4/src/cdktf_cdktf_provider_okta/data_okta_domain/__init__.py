...
class DataOktaDomain(
    ...
    def __init__(
        ...
        *,
        ...
        :param domain_id_or_name: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.4.3/docs/data-sources/domain#domain_id_or_name DataOktaDomain#domain_id_or_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
