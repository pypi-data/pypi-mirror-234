...
setup(
    name='method_detect',  # How you named your package folder (MyLib)
    packages=find_packages(),
    entry_points={
          'console_scripts': [
              'method_detect = method_detect.method_detect:main'
          ]
    },
    python_requires='>=3.7',
    version='2.1',  # Start with a small number and increase it with every change you make
    license='MIT',  # Chose a license from here: https://help.github.com/articles/licensing-a-repository
    description='YHMediator assistant tool for detect unimplementable method',
    ...
    keywords=['method_detect'],  # Keywords that define your package best
