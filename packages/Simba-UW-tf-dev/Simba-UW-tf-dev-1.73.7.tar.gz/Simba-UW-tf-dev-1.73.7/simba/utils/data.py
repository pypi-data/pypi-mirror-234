...
def slp_to_df_convert_updated(file_path: Union[str, os.PathLike],
                              headers: List[str],
                              joined_tracks: Optional[bool] = False,
    ...
    >>> df = slp_to_df_convert_updated(file_path='/Users/simon/Desktop/envs/troubleshooting/ryan/LBN4a_Ctrl_P05_1_2022-01-15_08-16-20c.h5', headers=new_headers, joined_tracks=True)
    """
    ...
    with h5py.File(file_path, "r") as f:
        ...
        if missing_keys:
            raise InvalidFileTypeError(msg=f'{file_path} is not a valid SLEAP H5 file. Missing keys: {missing_keys}', source=slp_to_df_convert_updated.__name__)
        tracks = f["tracks"][:].T
    ...
    if len(data_df.columns) != len(sleap_header):
        raise BodypartColumnNotFoundError(
            ...
            source=slp_to_df_convert_updated.__name__)
