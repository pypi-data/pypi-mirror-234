...
from ..models.base_search_input_ui_block_item_type import BaseSearchInputUIBlockItemType
...
class SearchInputUiBlockCreate:
    ...
    _item_type: Union[Unset, BaseSearchInputUIBlockItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_item_type() -> Union[Unset, BaseSearchInputUIBlockItemType]:
            item_type = UNSET
            _item_type = d.pop("itemType")
            if _item_type is not None and _item_type is not UNSET:
                try:
                    item_type = BaseSearchInputUIBlockItemType(_item_type)
                except ValueError:
                    item_type = BaseSearchInputUIBlockItemType.of_unknown(_item_type)
        ...
        try:
            ...
            if strict:
                raise
            item_type = cast(Union[Unset, BaseSearchInputUIBlockItemType], UNSET)
    ...
    @property
    def item_type(self) -> BaseSearchInputUIBlockItemType:
        if isinstance(self._item_type, Unset):
            raise NotPresentError(self, "item_type")
        return self._item_type

    @item_type.setter
    def item_type(self, value: BaseSearchInputUIBlockItemType) -> None:
