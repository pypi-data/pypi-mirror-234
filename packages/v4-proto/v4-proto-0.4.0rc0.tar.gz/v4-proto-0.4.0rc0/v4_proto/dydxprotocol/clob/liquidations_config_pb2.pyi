...
class LiquidationsConfig(_message.Message):
    __slots__ = ["max_insurance_fund_quantums_for_deleveraging", "max_liquidation_fee_ppm", "position_block_limits", "subaccount_block_limits", "fillable_price_config"]
    MAX_INSURANCE_FUND_QUANTUMS_FOR_DELEVERAGING_FIELD_NUMBER: _ClassVar[int]
    ...
    max_insurance_fund_quantums_for_deleveraging: int
    ...
    def __init__(self, max_insurance_fund_quantums_for_deleveraging: _Optional[int] = ..., max_liquidation_fee_ppm: _Optional[int] = ..., position_block_limits: _Optional[_Union[PositionBlockLimits, _Mapping]] = ..., subaccount_block_limits: _Optional[_Union[SubaccountBlockLimits, _Mapping]] = ..., fillable_price_config: _Optional[_Union[FillablePriceConfig, _Mapping]] = ...) -> None: ...
