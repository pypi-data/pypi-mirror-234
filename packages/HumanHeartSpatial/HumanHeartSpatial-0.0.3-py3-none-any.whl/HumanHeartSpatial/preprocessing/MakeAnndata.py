...
class MakeAnndata:
    ...
    def __init__(self, sample_path, barcodes_path):
        ...
        # the data will be the anndata with spatial coordinates.
        print('To get raw adata with spatial coordinates: call .data after class initiation')
    ...
    def _shared_barcodes(self):
        ...
        # Finds the overlap in barcodes between anndata and whitelist
        # Adds the corresponding spacial coordinates from whitelist to anndata
