...
class GetCod:
    ...
    def __init__(self, rangebin: np.array, signal: np.array, sigma: np.array, molecular_data: xr.Dataset,
                 cloud_lims: list, fit_region: list):
...
class LidarRatioCalculator:
    def __init__(self, rangebin: np.array, signal: np.array, sigma: np.array, molecular_data: xr.Dataset,
                 molecular_reference_region: list, cloud_lims: list, fit_region: list, mc=False, mc_niter=100,
    ...
    def _compute_tau(self):
        self.tau_mean, self.tau_std_mean = GetCod(rangebin=self.rangebin, signal=self.signal, sigma=self.sigma,
