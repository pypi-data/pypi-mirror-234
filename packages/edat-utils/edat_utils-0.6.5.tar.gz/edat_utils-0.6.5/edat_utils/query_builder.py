                ...
                for key_dict in list(value.keys()):
                    ...
                    match key:
                        ...
                        case 'ne':
                            where.append(key_dict + ' != ' + value_dict)
                        case 'like':
                            _termo = f'translate(lower({eval(value_dict)}), "áàâãäåaaaÁÂÃÄÅAAAÀéèêëeeeeeEEEÉEEÈìíîïìiiiÌÍÎÏÌIIIóôõöoooòÒÓÔÕÖOOOùúûüuuuuÙÚÛÜUUUUçÇñÑýÝ","aaaaaaaaaAAAAAAAAAeeeeeeeeeEEEEEEEiiiiiiiiIIIIIIIIooooooooOOOOOOOOuuuuuuuuUUUUUUUUcCnNyY")'
                            where.append(
                                'lower(' + key_dict + ')' + ' LIKE ' + "'%" + _termo + "%')")
                        case 'startWith':
                            _termo = f'translate(lower({eval(value_dict)}), "áàâãäåaaaÁÂÃÄÅAAAÀéèêëeeeeeEEEÉEEÈìíîïìiiiÌÍÎÏÌIIIóôõöoooòÒÓÔÕÖOOOùúûüuuuuÙÚÛÜUUUUçÇñÑýÝ","aaaaaaaaaAAAAAAAAAeeeeeeeeeEEEEEEEiiiiiiiiIIIIIIIIooooooooOOOOOOOOuuuuuuuuUUUUUUUUcCnNyY")'
                            where.append(
                                'lower(' + key_dict + ')' + ' LIKE ' + _termo + "%')")
