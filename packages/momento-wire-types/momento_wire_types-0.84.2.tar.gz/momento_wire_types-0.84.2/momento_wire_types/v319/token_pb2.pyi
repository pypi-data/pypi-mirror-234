...
class _GenerateDisposableTokenRequest(_message.Message):
    ...
    def __init__(self, expires: _Optional[_Union[_GenerateDisposableTokenRequest.Expires, _Mapping]] = ..., auth_token: _Optional[str] = ..., permissions: _Optional[_Union[_permissionmessages_pb2.Permissions, _Mapping]] = ...) -> None: ...
