...
def xtg_fseek_start(fhandle):
    return _cxtgeo.xtg_fseek_start(fhandle)
...
def x_conv_int2float(n, v1, v2):
    return _cxtgeo.x_conv_int2float(n, v1, v2)

def x_conv_int2double(n, v1, v2):
    return _cxtgeo.x_conv_int2double(n, v1, v2)

def x_conv_double2float(n, v1, v2):
    return _cxtgeo.x_conv_double2float(n, v1, v2)

def x_rotation_conv(ain, aimode, mode, option):
    return _cxtgeo.x_rotation_conv(ain, aimode, mode, option)
...
def grd3d_scan_roffbinary(fc, swig_out_char_msize, rectypes, reclengths, recstarts, maxkw):
    return _cxtgeo.grd3d_scan_roffbinary(fc, swig_out_char_msize, rectypes, reclengths, recstarts, maxkw)
...
def grd3d_zcorn_convert(nx, ny, nz, zcorn, zcornsv, option):
    return _cxtgeo.grd3d_zcorn_convert(nx, ny, nz, zcorn, zcornsv, option)
...
def grd3d_copy(ncol, nrow, nlay, p_coord1_v, p_zcorn1_v, p_actnum1_v, p_coord2_v, p_zcorn2_v, p_actnum2_v, iflag):
    return _cxtgeo.grd3d_copy(ncol, nrow, nlay, p_coord1_v, p_zcorn1_v, p_actnum1_v, p_coord2_v, p_zcorn2_v, p_actnum2_v, iflag)
...
def grdcp3d_export_xtgeo_grid(ncol, nrow, nlay, swig_np_dbl_inplaceflat_v1, swig_np_flt_inplaceflat_v1, swig_np_int_inplaceflat_v2, metadata, fc):
    return _cxtgeo.grdcp3d_export_xtgeo_grid(ncol, nrow, nlay, swig_np_dbl_inplaceflat_v1, swig_np_flt_inplaceflat_v1, swig_np_int_inplaceflat_v2, metadata, fc)

def grdcp3d_import_xtgeo_grid(mode, swig_np_dbl_inplaceflat_v1, swig_np_flt_inplaceflat_v1, swig_np_int_inplaceflat_v2, fc):
    return _cxtgeo.grdcp3d_import_xtgeo_grid(mode, swig_np_dbl_inplaceflat_v1, swig_np_flt_inplaceflat_v1, swig_np_int_inplaceflat_v2, fc)
