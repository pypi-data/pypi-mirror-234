...
package_version = environ.get("PACKAGE_VERSION", "1.0.0.32.2")
...
name = environ.get("PYPI_NAMESPACE", "test_dichen_proj")


def get_release_list() -> Any:
    """Returns go cli binary release list given package_version."""
    global go_package_version
    req = Request(
        f"https://api.github.com/repos/dbt-labs/dbt-cli/releases/v{go_package_version}",
        headers={
...
setup(
    ...
    description="Dbt cloud cli to interact with dbt cloud.",
    long_description="Dbt cloud cli to interact with dbt cloud.",
