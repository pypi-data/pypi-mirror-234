...
class SLADetermination:
    ...
    def categorize_lead_to_sale_diff(self):
    ...
    def categorize_lead_to_sale_interactions(self):
        ...
        # display(self.df_sale_inter)
   
    def calculate_cumulative_metrics(self):
        SLADetermination.categorize_lead_to_sale_interactions(self)
        ...
        self.df_sale_int_cum = self.df.groupby('Lead_to_Sale_Interactions_Group').size().reset_index(name='Count')
