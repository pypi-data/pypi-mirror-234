...
# d = get_stock_kline_data(token, "0.000903", is_explain=False, **h)
...
if __name__ == '__main__':
    ...
    # print(sharetop_obj)
    d = sharetop_obj.common_exec_func("stock_to_kline_data", {"limit": 10, "is_explain": False, "exchange_code": "SZSE"})
    # d = sharetop_obj
