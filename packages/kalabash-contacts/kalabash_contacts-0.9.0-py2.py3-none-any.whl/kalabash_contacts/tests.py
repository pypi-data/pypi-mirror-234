...
from kalabash.lib.tests import KbashAPITestCase, KbashTestCase
...
class AddressBookViewSetTestCase(TestDataMixin, KbashAPITestCase):
...
class CategoryViewSetTestCase(TestDataMixin, KbashAPITestCase):
...
class ContactViewSetTestCase(TestDataMixin, KbashAPITestCase):
...
class EmailAddressViewSetTestCase(TestDataMixin, KbashAPITestCase):
