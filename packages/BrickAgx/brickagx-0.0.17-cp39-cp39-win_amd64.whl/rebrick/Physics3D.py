...
class OrientedCoulombFriction(rebrick.Physics.CoulombFriction):
    ...
    def relative_transform(self):
        r"""relative_transform(OrientedCoulombFriction self) -> std::shared_ptr< Physics3D::Transform >"""
        return _Physics3DSwig.OrientedCoulombFriction_relative_transform(self)
