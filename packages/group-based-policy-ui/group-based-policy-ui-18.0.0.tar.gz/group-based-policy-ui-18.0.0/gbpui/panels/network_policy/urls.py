...
urlpatterns = [
    ...
    url(r'^update_externalconnectivity/(?P<external_connectivity_id>[^/]+)/$',
        views.UpdateExternalConnectivityView.as_view(),
        name='update_externalconnectivity'),
    url(r'^update_natpool/(?P<nat_pool_id>[^/]+)/$',
        views.UpdateNATPoolView.as_view(),
        name='update_natpool'),
    url(r'^natpool/(?P<nat_pool_id>[^/]+)/$',
    ...
    url(r'^externalconnectivity/(?P<external_connectivity_id>[^/]+)/$',
