...
class ProphecyDebugger:
                ...
                if target_file in filenames:
                    ...
                    try:
                        ...
                        with open(file_path, 'r') as file:
                            data = json.load(file)
                            ProphecyDebugger.log(None, data)
                            if 'url' in data:
                ...
                if any(name.endswith(filename) for name in z.namelist()):
                    for file_to_read in z.namelist():
                        with z.open(file_to_read) as json_file:
                            ...
                            ProphecyDebugger.log(None, f"Workflow json content {content}")
    ...
    def find_current_pipeline_code_in_path(cls, pipeline_uri):
        ...
        ProphecyDebugger.log(None, f"Could not find pipeline code for pipeline {pipeline_uri} {ProphecyDebugger.wheels_in_path()} {ProphecyDebugger.wheels_in_site_packages()}")
        return None
