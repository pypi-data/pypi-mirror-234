...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any groups from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any groups can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetDataAll(self, type, index):
        ...
        -------
        list
            A list containing data [Group.ADD or
    ...
    def SetDataAll(self, type, index, data):
        ...
        index : integer
            ...
            0 <= index <= Group.GetTotalAll()
        data : Array of data
            An array containing data [Group.ADD or
            Group.REMOVE, BOX (if defined)]
