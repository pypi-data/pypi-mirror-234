...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any deformable to rigids from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any deformable to rigids can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetDefToRegAutoCard(self, ctype, index):
        ...
        -------
        list
            A list of numbers containing the 2 or 3 member (depending on Card type):
            Part or Part Set ID, 
            LRB Part ID (only for card type D2R),
            and part type (PTYPE - Can be DeformableToRigid.PART or 
