...
# Static methods
    ...
    def FindTshellInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg):
        """
        Returns an array of Tshell objects for the thick shells within a box.
        ...
        """
        return Oasys.PRIMER._connection.classMethod(__class__.__name__, "FindTshellInBox", model, xmin, xmax, ymin, ymax, zmin, zmax, flag, excl)
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any thick shells from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any thick shells can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetNodeIDs(self):
        """
        Returns the labels of the nodes on the thick shell as an array.
    ...
    def GetNodes(self):
        """
        Returns the nodes on the thick shell as an array of Node objects.
