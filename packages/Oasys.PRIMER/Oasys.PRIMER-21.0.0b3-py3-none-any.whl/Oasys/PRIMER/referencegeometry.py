...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any airbag reference geometrys from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any airbag reference geometrys can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetNode(self, nid):
        ...
        -------
        list
            A list containing the three reference coordinates (or None if the node
            is not on the reference geometry)
        """
