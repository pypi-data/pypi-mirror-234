...
# Static methods
    ...
    def FindShellInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg):
        """
        Returns an array of Shell objects for the shells within a box.
        ...
        excl : integer
            ...
            (1) Apply exclusive selection rather than inclusive default
        ...
        """
        return Oasys.PRIMER._connection.classMethod(__class__.__name__, "FindShellInBox", model, xmin, xmax, ymin, ymax, zmin, zmax, flag, excl)
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any shells from any model can be selected.
            from any model
        modal : boolean
        ...
        button_text : string
            ...
            which if pressed will cancel the pick and return null. If you want to change the
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any shells can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def CoordsToIsoparametric(self, x, y, z):
        ...
        -------
        list
            List containing s and t isoparametric coordinates and the distance the point is from the shell
            (positive in direction of shell normal).
            If it is not possible to calculate the isoparametric coordinates None is returned
        """
    ...
    def ElemCut(self, database_cross_section_label):
        ...
        -------
        list
            A list containing the x1,y1,z1,x2,y2,z2 coordinates of the cut line, or None if it does not cut.
            Note this function does not check that the shell is in the cross section definition (part set)
        """
    ...
    def GetCompositeData(self, ipt):
        ...
        -------
        list
            A list containing the material ID, thickness and beta angle values. If the _COMPOSITE_LONG option
            is set, then the array returned will also contain the ply ID
        """
        return Oasys.PRIMER._connection.instanceMethod(self.__class__.__name__, self._handle, "GetCompositeData", ipt)

    def GetNodeIDs(self):
        """
        Returns the labels of the nodes on the shell as an array.
    ...
    def GetNodes(self):
        """
        Returns the nodes on the shell as an array of Node objects.
    ...
    def NormalVector(self):
        ...
        -------
        list
            List of numbers containing x, y and z components of unit normal vector or None if the vector cannot
            be calculated (for example if the shell has zero area)
        """
