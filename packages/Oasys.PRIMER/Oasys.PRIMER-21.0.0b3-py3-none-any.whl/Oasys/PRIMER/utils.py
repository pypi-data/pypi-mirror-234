...
# Static methods
    def Ascii85Decode(encoded):
        ...
        ArrayBuffer
            ArrayBuffer object
        """
        return Oasys.PRIMER._connection.classMethod(__class__.__name__, "Ascii85Decode", encoded)
    ...
    def Ascii85Encode(data, length=Oasys.gRPC.defaultArg):
        ...
        ?
            string
        """
        return Oasys.PRIMER._connection.classMethod(__class__.__name__, "Ascii85Encode", data, length)
