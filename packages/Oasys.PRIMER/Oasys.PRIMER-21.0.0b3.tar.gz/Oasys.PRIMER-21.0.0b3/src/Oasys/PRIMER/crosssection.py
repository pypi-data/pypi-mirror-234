...
# Static methods
    ...
    def CreateAlongFeatureLine(model, nid1, options):
        """
        Creates a set of cross sections along a feature line and returns them as an array of CrossSection objects. Use Options.edge_angle 
        ...
        -------
        list
            List of CrossSection objects (or None if not made). Depending on the geometry of the model and the node provided for nid1, the array 
            may contain less CrossSection objects than requested for the single node method
        """
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any cross sections from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any cross sections can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def Autosize(self, percentage=Oasys.gRPC.defaultArg):
        """
        ...
        ----------
        percentage : real
            Additional percentage that the autosized cross section will be scaled by
        ...
        None
            No return value
        """
        return Oasys.PRIMER._connection.instanceMethod(self.__class__.__name__, self._handle, "Autosize", percentage)
