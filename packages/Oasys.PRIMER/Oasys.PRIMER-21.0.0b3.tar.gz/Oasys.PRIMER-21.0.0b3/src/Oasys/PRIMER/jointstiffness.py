...
class JointStiffness(Oasys.gRPC.OasysItem, metaclass=JointStiffnessType):
    _props = {'cida', 'cidb', 'dlcidal', 'dlcidbt', 'dlcidg', 'dlcidp', 'dlcidph', 'dlcidps', 'dlcidr', 'dlcidt', 'dlcidx', 'dlcidy', 'dlcidz', 'esal', 'esbt', 'esph', 'esps', 'esr', 'est', 'esx', 'esy', 'esz', 'exists', 'fd', 'ffr', 'ffx', 'ffy', 'ffz', 'fmal', 'fmbt', 'fmph', 'fmps', 'fmt', 'fs', 'include', 'jid', 'label', 'lcidal', 'lcidbt', 'lcidg', 'lcidph', 'lcidps', 'lcidr', 'lcidt', 'lcidx', 'lcidy', 'lcidz', 'nsabt', 'nsaph', 'nsaps', 'nsat', 'nsdx', 'nsdy', 'nsdz', 'option', 'pida', 'pidb', 'psabt', 'psaph', 'psaps', 'psat', 'psdr', 'psdx', 'psdy', 'psdz', 'rad1', 'rad2', 'rps', 'saal'}
    _rprops = {'model'}
...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any joint stiffnesss from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any joint stiffnesss can be selected.
            from any model
        modal : boolean
