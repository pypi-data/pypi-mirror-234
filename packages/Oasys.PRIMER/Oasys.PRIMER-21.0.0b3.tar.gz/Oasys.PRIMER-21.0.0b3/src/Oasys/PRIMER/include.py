...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any includes from any model can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetDetailedRange(self, type_argument):
        ...
        -------
        list
            A list containing the min and max label ranges for the specified type or None
            if no range defined for this type
        """
    ...
    def GetLockedLabelData(self, rangenum):
        ...
        -------
        list
            A list containing the include name (string can also be "ALL" if range is applicable model-wide), 
            start (min) label (integer), end (max) label (integer), safe range (0 or 1 for False or True), and entity type (string)
        """
    ...
    def SetTransformOffset(self, offset, value, check_only=Oasys.gRPC.defaultArg):
        ...
        -------
        bool
            True if change successful. False if the change would cause a clash of labels or negative labels,
            in which case the value is not changed
        """
