...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any airbag shell reference geometrys from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any airbag shell reference geometrys can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetShell(self, eid):
        ...
        -------
        list
            A list containing the four reference node labels and the part ID (or None if the shell
            is not on the shell reference geometry)
        """
