...
# Static methods
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any materials from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any materials can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def GetPropertyByIndex(self, index):
        ...
        Material object or null if no property exists
    ...
    def GetPropertyNameForIndex(self, index):
        ...
        Material object or null if there is no property
