...
# Static methods
    ...
    def CoordsToIsoparametric(model, x, y, z, n1, n2, n3, n4):
        ...
        -------
        list
            List containing s and t isoparametric coordinates and the distance the point is from the segment
    ...
    def FindSolidInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg):
        """
        Returns an array of Solid objects for the solids within a box.
        ...
        excl : integer
            Optional flag to apply exclusive selection rather than inclusive default
        ...
        """
        return Oasys.PRIMER._connection.classMethod(__class__.__name__, "FindSolidInBox", model, xmin, xmax, ymin, ymax, zmin, zmax, flag, excl)
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any solids from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any solids can be selected.
            from any model
        modal : boolean
