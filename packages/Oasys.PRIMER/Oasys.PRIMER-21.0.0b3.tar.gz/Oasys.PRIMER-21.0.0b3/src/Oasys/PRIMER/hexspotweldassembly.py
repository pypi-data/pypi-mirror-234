...
# Static methods
    ...
    def GetAll(model):
        """
        Returns an array of HexSpotweldAssembly objects for all of the DEFINE_HEX_SPOTWELD_ASSEMBLYs in a model in Primer
    ...
    def GetFlagged(model, flag):
        """
        Returns an array of HexSpotweldAssembly objects for all of the flagged DEFINE_HEX_SPOTWELD_ASSEMBLYs in a model in Primer
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any DEFINE_HEX_SPOTWELD_ASSEMBLYs can be selected.
            from any model
        modal : boolean
