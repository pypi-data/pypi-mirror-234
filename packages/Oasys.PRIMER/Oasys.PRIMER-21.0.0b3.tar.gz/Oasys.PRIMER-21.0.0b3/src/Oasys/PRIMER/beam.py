...
# Static methods
    ...
    def FindBeamInBox(model, xmin, xmax, ymin, ymax, zmin, zmax, flag=Oasys.gRPC.defaultArg, excl=Oasys.gRPC.defaultArg):
        """
        Returns an array of Beam objects for the beams within a box.
        ...
        """
        return Oasys.PRIMER._connection.classMethod(__class__.__name__, "FindBeamInBox", model, xmin, xmax, ymin, ymax, zmin, zmax, flag, excl)
    ...
    def Pick(prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg, button_text=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any beams from any model can be selected.
            from any model
        modal : boolean
    ...
    def Select(flag, prompt, limit=Oasys.gRPC.defaultArg, modal=Oasys.gRPC.defaultArg):
        ...
        limit : Model or Flag
            ...
            If omitted, or null, any beams can be selected.
            from any model
        modal : boolean
...
# Instance methods
    ...
    def SectionPoints(self):
        ...
        They are returned in a single array of numbers
