...
import inspect
from typing import Any, List, Self, Callable, Optional, overload

# %% ../nbs/03_bflag.ipynb 4
from .types import (BoolCall, BoolFunc, Bools, BoolCalls)
...
from .butil import (bmap, bany, ball)
