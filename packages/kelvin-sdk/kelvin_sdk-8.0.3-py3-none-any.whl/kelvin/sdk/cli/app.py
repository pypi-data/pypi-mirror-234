...
@click.option("--description", required=False, type=click.STRING, help=KSDKHelpMessages.app_description)
@click.option(
    "--app-type",
    required=False,
    default=ProjectType.kelvin_v2.value,
...
@click.option(
    ...
    show_default=True,
    is_flag=True,
    help=KSDKHelpMessages.template,
)
@click.option(
    "--app-dir",
    type=click.Path(),
...
def create(
    ...
    return app_create_from_parameters(
        ...
        app_type=app_type,
        app_flavour=ApplicationFlavour(app_flavour),
