# inspired by https://github.com/normal-computing/outlines/blob/ee941fd60749d88ea92746935462edc253d53cd6/outlines/text/prompts.py
...
def prompt(id: str):
    def decorator(fn: Callable):
        ...
        return Prompt(id, template, signature)
