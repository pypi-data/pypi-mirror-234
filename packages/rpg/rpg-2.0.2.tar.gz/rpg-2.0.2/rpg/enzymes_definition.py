...
# Asp-N of Peptide Cutter
# https://web.expasy.org/peptide_cutter/peptidecutter_enzymes.html#AspN
# RULES: before D
ENZ = []
ENZ.append(rule.Rule(0, "D", True, 0))
ENZYME = enzyme.Enzyme(CPT_ENZ, "Asp-N Endopeptidase", ENZ, 0)
# Add it to available enzymes
AVAILABLE_ENZYMES.append(ENZYME)
CPT_ENZ += 1
...
# ProAlanase Sequencing Grade
# https://france.promega.com/products/mass-spectrometry/proteases-and-surfactants/proalanase-mass-spec-grade?catNum=VA2161
# RULES: after A or P
ENZ = []
ENZ.append(rule.Rule(0, "A", True, 1))
ENZ.append(rule.Rule(0, "P", True, 1))
ENZYME = enzyme.Enzyme(CPT_ENZ, "ProAlanase", ENZ, 0)
# Add it to available enzymes
AVAILABLE_ENZYMES.append(ENZYME)
CPT_ENZ += 1
