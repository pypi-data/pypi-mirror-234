...
class Locbuf(object):
    ...
    def new_csv(self, func, funcname, filename, dfdt_arg, instance, *args, **kwargs):
        ...
        def decorate(func, *args):
            ...
            def wrapper(instance, *args, **kwargs):
                ...
                if not stockfile:
                    ...
                    drydf = self.new_csv(
                        func, funcname, filename, dfdt_arg, instance, *args, **kwargs)
                    return drydf
                ...
                try:
                    ...
                    logger.info('file broken, get new {} -> {}'.format(funcname, filename))
                    drydf = self.new_csv(
                        func, funcname, filename, dfdt_arg, instance, *args, **kwargs)
                    return drydf
