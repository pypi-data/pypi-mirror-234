...
class TestSkipSocket(IncludeExcludeFunctionalTest):
    ...
    def test_socket_skipped_files_from(self):
        with io.open("testfiles/files_from.txt", "w") as f:
            f.write("various_file_types/changeable_permission\n"
...
class TestFilesFrom(IncludeExcludeFunctionalTest):
    ...
    def test_error_on_files_from_absolute_path(self):
        ...
        with io.open("testfiles/files_from.txt", "w") as f:
            f.write("/testfiles/select2/1/1sub1/1sub1sub1/1sub1sub1_file.txt\n"
    ...
    def test_files_from_implicit_parents(self):
        ...
        self.assertEqual(restored, [["1", "2", "3"],
                                    ["1sub1"], ["1sub1sub1", "1sub1sub2", "1sub1sub3"],
                                    ["1sub1sub1_file.txt"], ["1sub1sub2_file.txt"], ["1sub1sub3_file.txt"],
                                    ["2sub1"], ["2sub1sub1"], ["2sub1sub1_file.txt"],
                                    ["3sub3"], ["3sub3sub2"], ["3sub3sub2_file.txt"]])

    def test_files_from_trailing_space(self):
        """ Check that trailing space is preserved """
        with io.open("testfiles/files_from.txt", "w") as f:
            f.write("trailing_space /trailing_space sub1\n"
    ...
    def test_files_from_with_exclusions(self):
        ...
        self.backup("full", "testfiles/select2",
                    options=["--files-from", "testfiles/files_from.txt",
                             "--exclude", "testfiles/select2/2",
                             "--exclude", "testfiles/select2/3",
                             "--exclude", "**.txt"])
        self.restore()
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
        self.assertEqual(restored, [["1", "1.doc", "1.py"],
                                    ["1sub1", "1sub2", "1sub3"],
                                    ["1sub1sub1", "1sub1sub2", "1sub1sub3"],
                                    ["1sub2sub1", "1sub2sub2", "1sub2sub3"],
                                    ["1sub3sub1", "1sub3sub2", "1sub3sub3"]])
    ...
    def test_files_from_with_inclusions(self):
        ...
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
        self.assertEqual(restored, [["1", "2", "3", "1.doc", "1.py"],
                                    ["1sub1"], ["1sub1sub1", "1sub1sub2", "1sub1sub3"],
                                    ["1sub1sub1_file.txt"], ["1sub1sub2_file.txt"], ["1sub1sub3_file.txt"],
                                    ["2sub1"], ["2sub1sub1"], ["2sub1sub1_file.txt"],
                                    ["3sub3"], ["3sub3sub2"], ["3sub3sub2_file.txt"]])
    ...
    def test_files_from_multiple_filelists(self):
        ...
        with io.open("testfiles/files_from.txt", "w") as f:
            f.write("\n".join(self.testfiles_numbers))
        with io.open("testfiles/include.txt", "w") as f:
            f.write("testfiles/select2/1/1sub2\n"
                    ...
                    "testfiles/select2/trailing_space*")  # last include does nothing due to --files-from
        self.backup("full", "testfiles/select2",
                    options=["--files-from", "testfiles/files_from.txt",
                             "--include-filelist", "testfiles/include.txt",
                             "--exclude", "**"])
        self.restore()
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
    ...
    def test_files_from_null_separator(self):
        ...
        self.backup("full", "testfiles/select2",
                    options=["--null-separator",
                             "--files-from", "testfiles/files_from.txt",
                             "--include", "testfiles/select2/1/1sub2",
                             "--include", "testfiles/select2/1/1sub3",
                             "--include", "testfiles/select2/2/2sub2",
                             "--include", "testfiles/select2/2/2sub3",
                             "--include", "testfiles/select2/3/3sub1",
                             "--include", "testfiles/select2/3/3sub2",
                             "--exclude", "**"])
        self.restore()
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
...
class TestIncludeExcludeOptions(IncludeExcludeFunctionalTest):
    ...
    def test_include_exclude_trailing_whitespace(self):
        ...
        self.backup("full", "testfiles/select2",
                    options=["--include", "testfiles/select2/trailing_space /trailing_space "
...
class TestIncludeExcludeFilterModes(IncludeExcludeFunctionalTest):
    ...
    def test_error_on_redundant_filter_option(self):
        ...
        with self.assertRaises(CmdError) as context:
            self.backup("full", "testfiles/select2",
                        options=["--filter-globbing", "--filter-strictcase",
                                 "--include", "testfiles/dir1/fifo",
                                 "--include", "testfiles/dir1/symbolic_link",
                                 "--include", "testfiles/dir1/largefile",
                                 "--exclude", "testfiles/dir1"])
    ...
    def test_error_on_trailing_filter_option(self):
        ...
        with self.assertRaises(CmdError) as context:
            self.backup("full", "testfiles/select2",
                        options=["--include", "testfiles/dir1/fifo",
                                 "--include", "testfiles/dir1/symbolic_link",
                                 "--include", "testfiles/dir1/largefile",
                                 "--exclude", "testfiles/dir1",
                                 "--filter-literal"])
    ...
    def test_include_exclude_trailing_whitespace_with_modes(self):
        ...
        # should return a list of strings after having correctly processed quotes etc.
        self.backup("full", "testfiles/select2",
                    options=["--filter-literal",
                             "--include", "testfiles/select2/trailing_space /trailing_space sub2/trailing_space "
                                          "sub2_file.txt",
                             "--exclude", "testfiles/select2/trailing_space /trailing_space sub2",
                             "--include", "testfiles/select2/trailing_space ",
                             "--include", "testfiles/select2/3/3sub3/3sub3sub2/3sub3sub2_file.txt",
    ...
    def test_literal_multiple_mode_switches(self):
        self.backup("full", "testfiles/select2",
                    options=["--include", "testfiles/select2/**doc",
                             "--exclude", "testfiles/select2/1/*/*/*.txt",
                             "--filter-literal",
                             "--exclude", "testfiles/select2/2/2sub1/2sub1sub1/2sub1sub1_file.txt",
                             "--filter-regexp",
                             "--include", "testfiles/select2/1/1sub[13]/1sub[13]sub[123]",
                             "--include", "testfiles/select2/2/2sub1/2sub1sub[12]",
                             "--filter-literal",
                             "--include", "testfiles/select2/trailing_space /trailing_space sub2/trailing_space "
                                          "sub2_file.txt",
                             "--include", "testfiles/select2/3/3sub3/3sub3sub2/3sub3sub2_file.txt",
        ...
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
        self.assertEqual(restored, [["1", "2", "3", "trailing_space ", "1.doc"],
                                    ["1sub1", "1sub3"],
                                    ["1sub1sub1", "1sub1sub2", "1sub1sub3"],
                                    ["1sub3sub1", "1sub3sub2", "1sub3sub3"],
                                    ["2sub1"], ["2sub1sub1", "2sub1sub2"],
                                    ["3sub3"], ["3sub3sub2"], ["3sub3sub2_file.txt"],
                                    ["trailing_space sub2"],
                                    ["trailing_space sub2_file.txt"]])
    ...
    def test_literal_multiple_mode_switches_with_ignorecase_prefix(self):
        self.backup("full", "testfiles/select2",
                    options=["--include", "ignorecase:tEStfiles/sElect2/**doc",
                             "--exclude", "ignorecase:testfIles/seLEct2/1/*/*/*.txt",
                             "--filter-literal",
                             "--exclude", "testfiles/select2/2/2sub1/2sub1sub1/2sub1sub1_file.txt",
                             "--filter-regexp",
                             "--include", "testfiles/select2/1/1sub[13]/1sub[13]sub[123]",
                             "--include", "testfiles/select2/2/2sub1/2sub1sub[12]",
                             "--filter-literal",
                             "--include", "testfiles/select2/trailing_space /trailing_space "
                                          "sub2/trailing_space sub2_file.txt",
                             "--include", "testfiles/select2/3/3sub3/3sub3sub2/3sub3sub2_file.txt",
                             "--filter-globbing",
                             "--exclude", "ignorecase:TestFiles/SELECT2/*"])
        self.restore()
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
        self.assertEqual(restored, [["1", "2", "3", "trailing_space ", "1.doc"],
    ...
    def test_literal_multiple_mode_switches_with_filter_ignorecase(self):
        self.backup("full", "testfiles/select2",
                    options=["--filter-ignorecase",
                             "--include", "tEStfiles/sElect2/**doc",
                             "--exclude", "testfIles/seLEct2/1/*/*/*.txt",
                             "--filter-literal",
                             "--exclude", "Testfiles/select2/2/2SUB1/2sub1sUb1/2sUb1sUb1_file.txt",
                             "--filter-regexp",
...
class TestIncludeSpecialGlobChars(IncludeExcludeFunctionalTest):
    ...
    def test_literal_special_shell_chars(self):
        ...
        """
        self.backup("full", "testfiles/shell_glob_chars",
                    options=["--filter-literal",
                             "--include", "testfiles/shell_glob_chars/0?1/1?1/0?1sub1?1_file.txt",
                             "--exclude", "testfiles/shell_glob_chars/0?1",
                             "--exclude", "testfiles/shell_glob_chars/0*1/2*2/0*1sub2*2_file.txt",
                             "--exclude", "testfiles/shell_glob_chars/[01]/3?3/[01]sub3?3_file.txt"])
        self.restore()
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
        self.assertEqual(restored, [["0*1", "0?1", "[01]"],
                                    ["2*2", "2?2", "[02]"], ["0*1sub2?2_file.txt"], ["0*1sub[02]_file.txt"],
                                    ["1?1"], ["0?1sub1?1_file.txt"],
                                    ["3*3", "3?3", "[03]"], ["[01]sub3*3_file.txt"], ["[01]sub[03]_file.txt"]])
    ...
    def test_globbing_special_shell_chars(self):
        ...
        self.backup("full", "testfiles/shell_glob_chars",
                    options=["--filter-literal",
                             "--include", "testfiles/shell_glob_chars/0*1/2*2/0*1sub2*2_file.txt",
                             "--filter-globbing",
                             "--exclude", "testfiles/shell_glob_chars/0*1"])
        self.restore()
        restore_path = "testfiles/restore_out"
        restored = self.directory_tree_to_list_of_lists(restore_path)
        self.assertEqual(restored, [["0*1", "[01]"],
                                    ["2*2"], ["0*1sub2*2_file.txt"],
                                    ["3*3", "3?3", "[03]"], ["[01]sub3*3_file.txt"], ["[01]sub3?3_file.txt"],
                                    ["[01]sub[03]_file.txt"]])
    ...
    def test_filelist_special_shell_chars(self):
        ...
        """
        with io.open("testfiles/include.txt", "w") as f:
            f.write("testfiles/shell_glob_chars/0?1/1?1/0?1sub1?1_file.txt\n"
    ...
    def test_globbing_replacement_in_includes_using_filter_ignorecase(self):
        ...
        self.backup("full", "testfiles/select2",
                    options=["--include", "testfiles/select2/**/3sub3sub2/3sub3su?2_file.txt",  # Note ** and ? added
                             ...
                             "--exclude", "testfiles/select2/**/2sub1sub3",  # Note ** added
                             "--filter-ignorecase",
                             "--exclude", "testfiles/select2/2/2sub1/2Sub1Sub2",  # Note ignorecase added
                             "--include", "testfiles/sel[w,u,e,q]ct2/2/2S?b1",  # Note ignorecase, [] and
                             "--filter-strictcase",
                             # ? added
                             "--exclude", "testfiles/select2/1/1sub3/1s[w,u,p,q]b3sub2",  # Note [] added
                             "--exclude", "testfiles/select2/1/1sub[1-4]/1sub3sub1",  # Note [range] added
