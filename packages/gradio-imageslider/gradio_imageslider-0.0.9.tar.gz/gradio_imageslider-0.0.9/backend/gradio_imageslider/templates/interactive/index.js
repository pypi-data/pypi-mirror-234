...
function gi(e, t, n) {
  ...
  function b(d) {
    a && (n(3, c = di(d.clientX - h - f.left, -10, f.width - 10)), n(8, s = mi((c + 10) / f.width, 5)));
  }
  function v() {
  ...
  return e.$$set = (d) => {
    "position" in d && n(8, s = d.position), "disabled" in d && n(0, o = d.disabled), "$$scope" in d && n(9, i = d.$$scope);
  }, [
    o,
    u,
    l,
...
function Oi(e, t, n) {
  let { $$slots: r = {}, $$scope: i } = t, { height: s = void 0 } = t, { width: o = void 0 } = t, { elem_id: a = "" } = t, { elem_classes: u = [] } = t, { variant: l = "solid" } = t, { border_mode: f = "base" } = t, { padding: c = !0 } = t, { type: h = "normal" } = t, { test_id: _ = void 0 } = t, { explicit_call: m = !1 } = t, { container: b = !0 } = t, { visible: v = !0 } = t, { allow_overflow: S = !0 } = t, { scale: p = null } = t, { min_width: d = 0 } = t, B = h === "fieldset" ? "fieldset" : "div";
  return e.$$set = (y) => {
    "height" in y && n(0, s = y.height), "width" in y && n(1, o = y.width), "elem_id" in y && n(2, a = y.elem_id), "elem_classes" in y && n(3, u = y.elem_classes), "variant" in y && n(4, l = y.variant), "border_mode" in y && n(5, f = y.border_mode), "padding" in y && n(6, c = y.padding), "type" in y && n(15, h = y.type), "test_id" in y && n(7, _ = y.test_id), "explicit_call" in y && n(8, m = y.explicit_call), "container" in y && n(9, b = y.container), "visible" in y && n(10, v = y.visible), "allow_overflow" in y && n(11, S = y.allow_overflow), "scale" in y && n(12, p = y.scale), "min_width" in y && n(13, d = y.min_width), "$$scope" in y && n(16, i = y.$$scope);
  }, [
    s,
    o,
    a,
...
function pn(e, t = {}) {
  ...
  let o, a, u, l = e, f = e, c = 1, h = 0, _ = !1;
  function m(v, S = {}) {
    f = v;
    const p = u = {};
    return e == null || S.hard || b.stiffness >= 1 && b.damping >= 1 ? (_ = !0, o = mn(), l = v, n.set(e = f), Promise.resolve()) : (S.soft && (h = 1 / ((S.soft === !0 ? 0.5 : +S.soft) * 60), c = 0), a || (o = mn(), _ = !1, a = us((d) => {
      if (_)
        return _ = !1, a = null, !1;
      c = Math.min(c + h, 1);
      const B = {
      ...
      return o = d, l = e, n.set(e = y), B.settled && (a = null), !B.settled;
    })), new Promise((d) => {
      a.promise.then(() => {
        p === u && d();
      });
...
function Xe(e, t) {
  return t.clone !== !1 && t.isMergeableObject(e) ? Ce(bs(e), e, t) : e;
}
function ys(e, t, n) {
  ...
  for (var t = {}, n = 0, r = e; n < r.length; n++) {
    ...
    switch (i.stem) {
      ...
      case "integer-width":
        ...
        i.options[0].replace(xs, function(u, l, f, c, h, _) {
          if (l)
    ...
    if (vn.test(i.stem)) {
      ...
      i.stem.replace(vn, function(u, l, f, c, h, _) {
        return f === "*" ? t.minimumFractionDigits = l.length : c && c[0] === "#" ? t.maximumFractionDigits = c.length : h && _ ? (t.minimumFractionDigits = h.length, t.maximumFractionDigits = h.length + _.length) : (t.minimumFractionDigits = l.length, t.maximumFractionDigits = l.length), "";
      });
      var s = i.options[0];
      ...
      switch (a) {
        ...
        case "time": {
          ...
          if (l && Sn(l == null ? void 0 : l.style, "::", 0)) {
            var v = Qs(l.style.slice(2));
            if (a === "number") {
              var c = this.parseNumberSkeletonFromString(v, l.styleLocation);
              return c.err ? c : {
                val: { type: M.number, value: r, location: b, style: c.val },
                err: null
              };
            } else {
              if (v.length === 0)
              ...
              var S = v;
              this.locale && (S = Rs(v, this.locale));
              var h = {
                type: Oe.dateTime,
                pattern: S,
                location: l.styleLocation,
                parsedOptions: this.shouldParseSkeletons ? Is(S) : {}
              }, p = a === "date" ? M.date : M.time;
              return {
                val: { type: p, value: r, location: b, style: h },
                err: null
              };
            }
          }
        ...
        case "select": {
          ...
          if (this.bumpSpace(), !this.bumpIf(","))
            return this.error(N.EXPECT_SELECT_ARGUMENT_OPTIONS, C(d, L({}, d)));
          this.bumpSpace();
          ...
          if (a !== "select" && B.value === "offset") {
            ...
            if (c.err)
              return c;
            this.bumpSpace(), B = this.parseIdentifierIfPossible(), y = c.val;
          }
          var V = this.tryParsePluralOrSelectOptions(t, a, n, B);
          if (V.err)
            return V;
          var m = this.tryParseArgumentClose(i);
          if (m.err)
...
function ot(e, t, n, r, i, s, o) {
  ...
  for (var a = [], u = 0, l = e; u < l.length; u++) {
    ...
    if (br(f)) {
      var _ = typeof f.style == "string" ? r.date[f.style] : Zt(f.style) ? f.style.parsedOptions : void 0;
      a.push({
        type: X.literal,
    ...
    if (yr(f)) {
      var _ = typeof f.style == "string" ? r.time[f.style] : Zt(f.style) ? f.style.parsedOptions : r.time.medium;
      a.push({
        type: X.literal,
        value: n.getDateTimeFormat(t, _).format(h)
      });
    ...
    if (pr(f)) {
      var _ = typeof f.style == "string" ? r.number[f.style] : Sr(f.style) ? f.style.parsedOptions : void 0;
    ...
    if (Er(f)) {
      ...
      if (!ho(v))
        throw new uo(b, "function", o);
      var S = ot(m, t, n, r, i, s), p = v(S.map(function(y) {
        return y.value;
      }));
      Array.isArray(p) || (p = [p]), a.push.apply(a, p.map(function(y) {
        return {
          type: typeof y == "string" ? X.literal : X.object,
          value: y
        };
      }));
    }
    if (vr(f)) {
      ...
      a.push.apply(a, ot(d.value, t, n, r, i));
      continue;
    }
    if (wr(f)) {
...
`, Le.MISSING_INTL_API, o);
        var B = n.getPluralRules(t, { type: f.pluralType }).select(h - (f.offset || 0));
        d = f.options[B] || f.options.other;
      }
      if (!d)
        throw new An(f.value, h, Object.keys(f.options), o);
      a.push.apply(a, ot(d.value, t, n, r, i, h - (f.offset || 0)));
      continue;
    }
  }
  return co(a);
...
function St(e, t = xe().fallbackLocale) {
  const n = Pn(e);
...
const Ze = (e, t) => {
  ...
  let f = Lr(e, u);
  if (!f)
    f = (s = (i = (r = (n = xe()).handleMissingMessage) == null ? void 0 : r.call(n, { locale: u, id: e, defaultValue: l })) != null ? i : l) != null ? s : e;
  ...
  return c;
}, Zo = (e, t) => Vo(t).format(e), Wo = (e, t) => qo(t).format(e), Jo = (e, t) => jo(t).format(e), Qo = (e, t = Ae()) => Lr(e, t), Yo = Re([Ke, Ye], () => Xo);
Re([Ke], () => Zo);
Re([Ke], () => Wo);
Re([Ke], () => Jo);
Re([Ke, Ye], () => Qo);
...
function ra(e) {
  ...
  return {
    c() {
      t = On("div"), r = qe(n), i = xn(), s = On("span"), o = qe("- "), u = qe(a), l = qe(" -"), f = xn(), h = qe(c), Cn(s, "class", "or svelte-8ytugg"), Cn(t, "class", "wrap svelte-8ytugg");
    },
    m(_, m) {
      ta(_, t, m), be(t, r), be(t, i), be(t, s), be(s, o), be(s, u), be(s, l), be(t, f), be(t, h);
    },
    p(_, [m]) {
      m & /*i18n, type*/
      3 && n !== (n = /*i18n*/
      ...
      2 && a !== (a = /*i18n*/
      _[1]("common.or") + "") && Ft(u, a), m & /*i18n*/
      2 && c !== (c = /*i18n*/
      _[1]("upload_text.click_to_upload") + "") && Ft(h, c);
    },
    i: Ln,
    o: Ln,
    d(_) {
...
function da(e) {
  ...
  async function n(s, o, a) {
    ...
    for (let h = 0; h < o.length; h += l) {
      const _ = o.slice(h, h + l), m = new FormData();
      _.forEach((v) => {
        m.append("files", v);
      });
      try {
  ...
  async function r(s, o = { normalise_files: !0 }) {
    return new Promise(async (a) => {
      ...
      const { ws_protocol: _, http_protocol: m, host: b, space_id: v } = await fa(s, l), S = Math.random().toString(36).substring(2), p = {};
      let d, B = {}, y = !1;
      l && v && (y = await pa(v, l));
      async function V(P) {
        if (d = P, B = ca((P == null ? void 0 : P.dependencies) || []), d.auth_required)
          return {
            config: d,
            ...c
          };
      ...
      try {
        ...
        console.error(P), v ? nn(
          v,
          Ur.test(v) ? "space_name" : "subdomain",
          te
        ) : u && u({
          status: "error",
          message: "Could not load this space.",
      ...
      function se(P, k, g) {
        ...
        return new Promise((x, de) => {
          ...
          let oe;
          Y.on("data", (D) => {
            U && (Y.destroy(), x(D)), w = !0, oe = D;
          }).on("status", (D) => {
            D.stage === "error" && de(D), D.stage === "complete" && (U = !0, Y.destroy(), w && x(oe));
          });
        });
      }
      function Z(P, k, g) {
        let w, U;
        if (typeof P == "number")
          w = P, U = G.unnamed_endpoints[w];
        else {
          const j = P.replace(/^\//, "");
          w = B[j], U = G.named_endpoints[P.trim()];
        }
        if (typeof w != "number")
          throw new Error(
        ...
        i(
          ...
          if (de = { data: j || [], event_data: g, fn_index: w }, ya(w, d))
            D({
              type: "status",
              endpoint: x,
              stage: "pending",
              ...
              `${m}//${b + d.path}/run${x.startsWith("/") ? x : `/${x}`}`,
              {
                ...de,
                session_hash: S
              },
            ...
            let q = new URL(`${_}://${b}${d.path}
							/queue/join`);
            y && q.searchParams.set("__sign", y), I = new WebSocket(q), I.onclose = (W) => {
              W.wasClean || D({
                type: "status",
                stage: "error",
                broken: !0,
              ...
              const J = JSON.parse(W.data), { type: me, status: ce, data: Fe } = va(
                J,
                p[w]
              );
              if (me === "update" && ce && !Y)
                ...
                I.send(JSON.stringify({ fn_index: w, session_hash: S }));
                return;
              } else
            ...
            }, Mn(d.version || "2.0.0", "3.6") < 0 && addEventListener(
              "open",
        ...
        function E(j, q) {
          const W = oe, J = W[j] || [];
          return W[j] = J, J == null || J.push(q), { on: E, off: $e, cancel: At, destroy: Ht };
        }
        function $e(j, q) {
          const W = oe;
          let J = W[j] || [];
          return J = J == null ? void 0 : J.filter((me) => me !== q), W[j] = J, { on: E, off: $e, cancel: At, destroy: Ht };
        }
        async function At() {
          const j = {
            stage: "complete",
          ...
          try {
            await e(
              `${m}//${b + d.path}/reset`,
              {
                ...
                method: "POST",
                body: JSON.stringify({ fn_index: w, session_hash: S })
              }
            );
          } catch {
            console.warn(
      ...
      async function T(P) {
        ...
        if (Mn(P.version || "2.0.0", "3.30") < 0 ? g = await e(
          ...
          throw new Error(rt);
        let w = await g.json();
        return "api" in w && (w = w.api), w.named_endpoints["/predict"] && !w.unnamed_endpoints[0] && (w.unnamed_endpoints[0] = w.named_endpoints["/predict"]), ga(w, P, B);
      }
    });
  }
  async function i(s, o, a, u) {
    ...
    return Promise.all(
      l.map(async ({ path: f, blob: c, data: h, type: _ }) => {
        if (c) {
          const m = (await n(s, [c], u)).files[0];
          return { path: f, file_url: m, type: _ };
        }
        return { path: f, base64: h, type: _ };
      })
    ).then((f) => (f.forEach(({ path: c, file_url: h, base64: _, type: m }) => {
      if (_)
        qt(o, _, c);
      else if (m === "Gallery")
        qt(o, h, c);
...
function Rn(e, t, n, r) {
  return e.map((i, s) => {
    var o, a, u, l;
    return ((a = (o = t == null ? void 0 : t.returns) == null ? void 0 : o[s]) == null ? void 0 : a.component) === "File" ? Ve(i, n, r) : ((l = (u = t == null ? void 0 : t.returns) == null ? void 0 : u[s]) == null ? void 0 : l.component) === "Gallery" ? i.map((f) => Array.isArray(f) ? [Ve(f[0], n, r), f[1]] : [Ve(f, n, r), null]) : typeof i == "object" && (i != null && i.is_file) ? Ve(i, n, r) : i;
  });
}
function Ve(e, t, n) {
  if (e == null)
  ...
  if (Array.isArray(e)) {
    const r = [];
    for (const i of e)
      i === null ? r.push(null) : r.push(Ve(i, t, n));
    return r;
  } else
...
function Da(e) {
  ...
  return {
    ...
    m(h, _) {
      Na(h, t, _), c && c.m(t, null), Gn(t, n), Gn(t, r), e[22](r), a = !0, u || (l = [
        K(
          r,
          "change",
          /*loadFilesFromUpload*/
    ...
    p(h, [_]) {
      ...
      16 && i !== (i = /*file_count*/
      h[4] === "multiple" || void 0)) && (r.multiple = i), (!a || _ & /*file_count*/
      16 && s !== (s = /*file_count*/
      h[4] === "directory" || void 0)) && he(r, "webkitdirectory", s), (!a || _ & /*file_count*/
      16 && o !== (o = /*file_count*/
      h[4] === "directory" || void 0)) && he(r, "mozdirectory", o), (!a || _ & /*center*/
      4) && Ne(
        t,
        "center",
        /*center*/
...
function Ga(e, t, n) {
  ...
  let { filetype: o = null } = t, { dragging: a = !1 } = t, { boundedheight: u = !0 } = t, { center: l = !0 } = t, { flex: f = !0 } = t, { file_count: c = "single" } = t, { disable_click: h = !1 } = t, { root: _ } = t, m;
  const b = Ma();
  function v() {
    n(10, a = !a);
  }
  ...
  async function p(g) {
    await ka();
    let w = (Array.isArray(g) ? g : [g]).map((U) => U.blob);
    await s(_, w).then(async (U) => {
      U.error ? (Array.isArray(g) ? g : [g]).forEach(async (I, x) => {
        I.data = await la(I.blob), I.blob = void 0;
      }) : (Array.isArray(g) ? g : [g]).forEach((I, x) => {
        U.files && (I.orig_name = I.name, I.name = U.files[x], I.is_file = !0, I.blob = void 0, ze(I, _, null));
      });
    }), b("load", c === "single" ? g[0] : g);
  }
  async function d(g) {
    let w = Array.from(g);
    if (g.length) {
  ...
  async function B(g) {
    const w = g.target;
    w.files && await d(w.files);
  }
  async function y(g) {
    n(10, a = !1), Fa([g, "access", (w) => w.dataTransfer, "optionalAccess", (w) => w.files]) && await d(g.dataTransfer.files);
  }
  function V(g) {
    we.call(this, e, g);
  }
  ...
  return e.$$set = (g) => {
    "filetype" in g && n(0, o = g.filetype), "dragging" in g && n(10, a = g.dragging), "boundedheight" in g && n(1, u = g.boundedheight), "center" in g && n(2, l = g.center), "flex" in g && n(3, f = g.flex), "file_count" in g && n(4, c = g.file_count), "disable_click" in g && n(11, h = g.disable_click), "root" in g && n(12, _ = g.root), "$$scope" in g && n(13, i = g.$$scope);
  }, [
    o,
    u,
    l,
...
function Za(e) {
  ...
  return {
    c() {
      t = Bt("img"), dt(t.src, n = /*value*/
      e[0][0].data) || ie(t, "src", n), ie(t, "alt", ""), ie(t, "class", "svelte-1s3r0d8");
    },
    m(r, i) {
      Je(r, t, i);
    },
...
function Wa(e) {
  ...
  return (
    /*dragging*/
    e[4] !== void 0 && (s.dragging = /*dragging*/
    e[4]), t = new Gr({ props: s }), Vr.push(() => qr(t, "dragging", i)), t.$on(
      "load",
      /*load_handler*/
      e[10]
    ), {
      ...
      p(a, u) {
        ...
        8 && (l.root = /*root*/
        a[3]), u & /*$$scope*/
        8192 && (l.$$scope = { dirty: u, ctx: a }), !n && u & /*dragging*/
        16 && (n = !0, l.dragging = /*dragging*/
        a[4], jr(() => n = !1)), t.$set(l);
      },
      i(a) {
...
function Qa(e) {
  ...
  return {
    c() {
      t = Bt("img"), dt(t.src, n = /*value*/
      e[0][1].data) || ie(t, "src", n), ie(t, "alt", ""), ie(t, "class", "svelte-1s3r0d8");
    },
    m(r, i) {
      Je(r, t, i);
    },
...
function $a(e) {
  ...
  return s = _(e), o = h[s] = c[s](e), {
    c() {
      t = Bt("div"), r.c(), i = Wr(), o.c(), ie(t, "class", "upload-wrap svelte-1s3r0d8");
    },
    m(m, b) {
      Je(m, t, b), l[n].m(t, null), qa(t, i), h[s].m(t, null), a = !0;
    },
    p(m, b) {
      let v = n;
      n = f(m), n === v ? l[n].p(m, b) : (Vn(), le(l[v], 1, 1, () => {
        l[v] = null;
      }), qn(), r = l[n], r ? r.p(m, b) : (r = l[n] = u[n](m), r.c()), ae(r, 1), r.m(t, i));
      let S = s;
      s = _(m), s === S ? h[s].p(m, b) : (Vn(), le(h[S], 1, 1, () => {
        h[S] = null;
      }), qn(), o = h[s], o ? o.p(m, b) : (o = h[s] = c[s](m), o.c()), ae(o, 1), o.m(t, null));
    },
    i(m) {
      a || (ae(r), ae(o), a = !0);
    },
...
function el(e) {
  ...
  return t = new Ji({
    ...
    p(o, [a]) {
      ...
      o[1] || "Image"), t.$set(u);
      const l = {};
      a & /*$$scope, value, root, dragging*/
      8217 && (l.$$scope = { dirty: a, ctx: o }), i.$set(l);
    },
    i(o) {
...
function tl(e, t, n) {
  let { $$slots: r = {}, $$scope: i } = t, { value: s } = t, { label: o = void 0 } = t, { show_label: a } = t, { pending: u = !1 } = t, { root: l } = t, { i18n: f } = t;
  function c({ detail: p }, d) {
    p.length > 1 ? (n(0, s[0] = ze(p[0], l, null), s), n(0, s[1] = ze(p[1], l, null), s)) : n(0, s[d] = ze(p[0], l, null), s), h("upload", s[d]);
  }
  const h = Xa();
  let _ = !1;
  function m(p) {
...
function fl(e) {
  ...
  return {
    ...
    m(_, m) {
      al(_, t, m), ne(t, n), ne(n, r), ne(r, i), ne(r, s), ne(r, o), ne(r, a), ne(n, u), ne(u, l), ne(u, f), ne(u, c), ne(u, h);
    },
    p(_, [m]) {
      m & /*$top*/
...
function Al(e) {
  ...
  return {
    ...
    m(u, l) {
      H(u, t, l), Te(t, r), H(u, i, l), a && a.m(u, l), s = !0;
    },
    p(u, l) {
      (!s || l[0] & /*i18n*/
      2) && n !== (n = /*i18n*/
...
function Hl(e) {
  ...
  return {
    c() {
      f && f.c(), t = fe(), n = _e("div"), _ && _.c(), r = fe(), m && m.c(), i = fe(), o && o.c(), a = fe(), p && p.c(), u = Ue(), ue(n, "class", "progress-text svelte-14miwb5"), $(
        n,
        "meta-text-center",
        /*variant*/
        e[8] === "center"
    ...
    m(d, B) {
      f && f.m(d, B), H(d, t, B), H(d, n, B), _ && _.m(n, null), Te(n, r), m && m.m(n, null), H(d, i, B), ~s && v[s].m(d, B), H(d, a, B), p && p.m(d, B), H(d, u, B), l = !0;
    },
    p(d, B) {
      /*variant*/
      d[8] === "default" && /*show_eta_bar*/
      d[18] && /*show_progress*/
      d[6] === "full" ? f ? f.p(d, B) : (f = Kn(d), f.c(), f.m(t.parentNode, t)) : f && (f.d(1), f = null), h === (h = c(d)) && _ ? _.p(d, B) : (_ && _.d(1), _ = h && h(d), _ && (_.c(), _.m(n, r))), /*timer*/
      d[5] ? m ? m.p(d, B) : (m = tr(d), m.c(), m.m(n, null)) : m && (m.d(1), m = null), (!l || B[0] & /*variant*/
      256) && $(
        n,
        "meta-text-center",
        /*variant*/
      ...
      let y = s;
      s = S(d), s === y ? ~s && v[s].p(d, B) : (o && (Kr(), ke(v[y], 1, 1, () => {
        v[y] = null;
      }), Qr()), ~s ? (o = v[s], o ? o.p(d, B) : (o = v[s] = b[s](d), o.c()), Me(o, 1), o.m(a.parentNode, a)) : o = null), /*timer*/
      d[5] ? p && (p.d(1), p = null) : p ? p.p(d, B) : (p = lr(d), p.c(), p.m(u.parentNode, u));
    },
    i(d) {
      l || (Me(o), l = !0);
    },
    ...
    d(d) {
      d && (A(t), A(n), A(i), A(a), A(u)), f && f.d(d), _ && _.d(), m && m.d(), ~s && v[s].d(d), p && p.d(d);
    }
  };
}
function Kn(e) {
...
function Pl(e) {
  ...
  return {
    ...
    m(a, u) {
      H(a, t, u), H(a, r, u), H(a, i, u), H(a, s, u), H(a, o, u);
    },
    p(a, u) {
      u[0] & /*queue_position*/
...
function $n(e) {
  ...
  return {
    ...
    m(f, c) {
      l.m(f, c), H(f, t, c), H(f, r, c), H(f, i, c), H(f, o, c);
    },
    p(f, c) {
...
function xl(e) {
  ...
  return {
    ...
    m(u, l) {
      H(u, t, l), Te(t, n), a && a.m(n, null), Te(t, r), Te(t, i), Te(i, s), e[30](s);
    },
    p(u, l) {
      /*progress*/
...
function rr(e) {
  ...
  return {
    c() {
      s && s.c(), t = fe(), o && o.c(), n = fe(), a && a.c(), r = fe(), u && u.c(), i = Ue();
    },
    m(l, f) {
      s && s.m(l, f), H(l, t, f), o && o.m(l, f), H(l, n, f), a && a.m(l, f), H(l, r, f), u && u.m(l, f), H(l, i, f);
    },
    p(l, f) {
      /*p*/
    ...
    d(l) {
      l && (A(t), A(n), A(r), A(i)), s && s.d(l), o && o.d(l), a && a.d(l), u && u.d(l);
    }
  };
}
function Ml(e) {
...
function kl(e) {
  ...
  return ~(n = u(e)) && (r = a[n] = o[n](e)), {
    ...
    m(l, f) {
      H(l, t, f), ~n && a[n].m(t, null), e[31](t), s = !0;
    },
    p(l, f) {
      let c = n;
      n = u(l), n === c ? ~n && a[n].p(l, f) : (r && (Kr(), ke(a[c], 1, 1, () => {
        a[c] = null;
      }), Qr()), ~n ? (r = a[n], r ? r.p(l, f) : (r = a[n] = o[n](l), r.c()), Me(r, 1), r.m(t, null)) : r = null), (!s || f[0] & /*variant, show_progress*/
...
function Dl(e, t, n) {
  let r, { $$slots: i = {}, $$scope: s } = t, { i18n: o } = t, { eta: a = null } = t, { queue: u = !1 } = t, { queue_position: l } = t, { queue_size: f } = t, { status: c } = t, { scroll_to_output: h = !1 } = t, { timer: _ = !0 } = t, { show_progress: m = "full" } = t, { message: b = null } = t, { progress: v = null } = t, { variant: S = "default" } = t, { loading_text: p = "Loading..." } = t, { absolute: d = !0 } = t, { translucent: B = !1 } = t, { border: y = !1 } = t, { autoscroll: V } = t, G, te = !1, se = 0, Z = 0, T = null, P = 0, k = null, g, w = null, U = !0;
  const I = () => {
  ...
  function oe(E) {
    Wn[E ? "unshift" : "push"](() => {
      w = E, n(16, w), n(7, v), n(14, k), n(15, g);
    });
  }
  function D(E) {
    Wn[E ? "unshift" : "push"](() => {
  ...
  return e.$$set = (E) => {
    "i18n" in E && n(1, o = E.i18n), "eta" in E && n(0, a = E.eta), "queue" in E && n(21, u = E.queue), "queue_position" in E && n(2, l = E.queue_position), "queue_size" in E && n(3, f = E.queue_size), "status" in E && n(4, c = E.status), "scroll_to_output" in E && n(22, h = E.scroll_to_output), "timer" in E && n(5, _ = E.timer), "show_progress" in E && n(6, m = E.show_progress), "message" in E && n(23, b = E.message), "progress" in E && n(7, v = E.progress), "variant" in E && n(8, S = E.variant), "loading_text" in E && n(9, p = E.loading_text), "absolute" in E && n(10, d = E.absolute), "translucent" in E && n(11, B = E.translucent), "border" in E && n(12, y = E.border), "autoscroll" in E && n(24, V = E.autoscroll), "$$scope" in E && n(28, s = E.$$scope);
  }, e.$$.update = () => {
    ...
    128 && v != null && n(18, U = !1), e.$$.dirty[0] & /*progress, progress_level, progress_bar, last_progress_level*/
    114816 && (v != null ? n(14, k = v.map((E) => {
      if (E.index != null && E.length != null)
        return E.index / E.length;
      if (E.progress != null)
        return E.progress;
    })) : n(14, k = null), k ? (n(15, g = k[k.length - 1]), w && (g === 0 ? n(16, w.style.transition = "0", w) : n(16, w.style.transition = "150ms", w))) : n(15, g = void 0)), e.$$.dirty[0] & /*status*/
  ...
  return (
    ...
    e[0]), r = new nl({ props: l }), Vl.push(() => ql(r, "value", u)), r.$on(
      ...
      p(f, c) {
        ...
        f[5]), c & /*pending*/
        64 && (_.pending = /*pending*/
        f[6]), c & /*gradio*/
        16384 && (_.i18n = /*gradio*/
        f[14].i18n), c & /*$$scope, gradio*/
        16793600 && (_.$$scope = { dirty: c, ctx: f }), !i && c & /*value*/
        1 && (i = !0, _.value = /*value*/
        f[0], Gl(() => i = !1)), r.$set(_);
      },
      i(f) {
...
const ur = 340;
function tu(e, t, n) {
  let { elem_id: r = "" } = t, { elem_classes: i = [] } = t, { visible: s = !0 } = t, { value: o = [null, null] } = t, { label: a } = t, { show_label: u } = t, { pending: l } = t, { height: f } = t, { width: c } = t, { container: h = !0 } = t, { scale: _ = null } = t, { min_width: m = void 0 } = t, { loading_status: b } = t, { root: v } = t, { gradio: S } = t, p;
  function d(T) {
    o = T, n(0, o);
  }
  const B = () => S.dispatch("edit"), y = () => S.dispatch("clear"), V = () => S.dispatch("stream"), G = ({ detail: T }) => n(15, p = T), te = () => S.dispatch("upload"), se = ({ detail: T }) => S.dispatch("select", T), Z = ({ detail: T }) => S.dispatch("share", T);
  return e.$$set = (T) => {
    "elem_id" in T && n(1, r = T.elem_id), "elem_classes" in T && n(2, i = T.elem_classes), "visible" in T && n(3, s = T.visible), "value" in T && n(0, o = T.value), "label" in T && n(4, a = T.label), "show_label" in T && n(5, u = T.show_label), "pending" in T && n(6, l = T.pending), "height" in T && n(7, f = T.height), "width" in T && n(8, c = T.width), "container" in T && n(9, h = T.container), "scale" in T && n(10, _ = T.scale), "min_width" in T && n(11, m = T.min_width), "loading_status" in T && n(12, b = T.loading_status), "root" in T && n(13, v = T.root), "gradio" in T && n(14, S = T.gradio);
  }, e.$$.update = () => {
    e.$$.dirty & /*value*/
