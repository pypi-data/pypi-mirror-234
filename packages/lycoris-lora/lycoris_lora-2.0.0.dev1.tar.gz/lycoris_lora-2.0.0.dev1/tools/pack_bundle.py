...
def get_args():
    ...
    parser.add_argument(
        "lora_model", help="The model you want to pack embeddings into it.",
        default='', type=str
    )
    parser.add_argument(
        "embeddings", help="the embeddings you want to pack into the lora model.",
        default='', type=str, nargs="+"
    )
    parser.add_argument(
        "output", help='output file name (with path)',
        default='', type=str, nargs='*'
    )
    parser.add_argument(
        "--safetensors", help='use safetensors to save bundled file',
